// node_modules/.pnpm/@wangeditor-next+editor@5.6.46/node_modules/@wangeditor-next/editor/dist/index.mjs
var e;
var t;
var n;
var r;
...
function E(e5) {
  if (Object.prototype.hasOwnProperty.call(e5, "__esModule"))
    return e5;
  var t2 = e5.default;
...
function O() {
  ...
  return f = function(n2) {
    if (e5(n2))
      throw new t2("Can't call method on " + n2);
    return n2;
  };
}
function N() {
...
function qt() {
  ...
  var e5 = Ht(), t2 = ye(), n2 = Ut(), r2 = Gt(), o2 = function() {
    ...
    return We = function(o3, i3) {
      var a3, s3;
      if ("string" === i3 && t3(a3 = o3.toString) && !n3(s3 = e6(a3, o3)))
        return s3;
      if (t3(a3 = o3.valueOf) && !n3(s3 = e6(a3, o3)))
        return s3;
      if ("string" !== i3 && t3(a3 = o3.toString) && !n3(s3 = e6(a3, o3)))
        return s3;
  ...
  return qe = function(i3, u2) {
    ...
    var l2, c2 = r2(i3, s2);
    if (c2) {
      if (void 0 === u2 && (u2 = "default"), l2 = e5(c2, i3, u2), !t2(l2) || n2(l2))
        return l2;
...
function Yt() {
  ...
  return Lt.f = e5 ? n2 ? function(e6, t3, n3) {
    ...
    if (r2(e6), n3 = o2(n3), r2(s3), t2)
      try {
        return a2(e6, n3, s3);
      } catch (e7) {
      }
    if ("get" in s3 || "set" in s3)
      throw new i2("Accessors not supported");
...
function tn() {
  ...
  return ft = function(e6, a2) {
    ...
    for (s2 in u2)
      !t2(o2, s2) && t2(u2, s2) && i2(c2, s2);
    for (; a2.length > l2; )
      t2(u2, s2 = a2[l2++]) && (~r2(c2, s2) || i2(c2, s2));
    return c2;
  }, ft;
}
function nn() {
...
function rn() {
  ...
  return Se.f = e5 && !t2 ? Object.defineProperties : function(e6, t3) {
    r2(e6);
    for (var a2, s2 = o2(t3), u2 = i2(t3), l2 = u2.length, c2 = 0; l2 > c2; )
      n2.f(e6, a2 = u2[c2++], s2[a2]);
    return e6;
  }, Se;
}
function on() {
...
function cn() {
  ...
  return _t = { set: e5, get: t2, has: n2, enforce: function(r3) {
    ...
    return function(n3) {
      var r3;
      if (!i2(n3) || (r3 = t2(n3)).type !== e6)
        throw new f2("Incompatible receiver, " + e6 + " required");
      return r3;
    };
  } };
}
...
function gn() {
  ...
  return pn.f = e5 ? u2 : function(e6, l2) {
    if (e6 = o2(e6), l2 = i2(l2), s2)
      try {
        return u2(e6, l2);
      } catch (e7) {
      }
    if (a2(e6, l2))
      return r2(!t2(n2.f, e6, l2), e6[l2]);
  }, pn;
}
var vn;
var mn;
...
function On() {
  ...
  return Cn = function(o2, i2, a2, s2) {
    ...
    if (e5(a2) && n2(a2, l2, s2), s2.global)
      u2 ? o2[i2] = a2 : r2(i2, a2);
    else {
      try {
...
function yr() {
  ...
  return rr = function(r3, d3, p3, w2, S2, A2, x2) {
    ...
    if (R2 && (O2 = a2(R2.call(new r3()))) !== Object.prototype && O2.next && (n2 || a2(O2) === v2 || (s2 ? s2(O2, v2) : o2(O2[y2]) || c2(O2, y2, D2)), u2(O2, k2, true, true), n2 && (f2[k2] = D2)), h2 && S2 === E2 && P2 && P2.name !== E2 && (!n2 && g2 ? l2(I2, "name", E2) : (F2 = true, _2 = function() {
      ...
      if (N2 = { values: T2(E2), keys: A2 ? _2 : T2(b2), entries: T2(C2) }, x2)
        for (B2 in N2)
          (m2 || F2 || !(B2 in I2)) && c2(I2, B2, N2[B2]);
      else
        e5({ target: d3, proto: true, forced: m2 || F2 }, N2);
...
function Er() {
  ...
  sr = i2(Array, "Array", function(t3, n3) {
    ...
    if (!t3 || n3 >= t3.length)
      return e6.target = null, a2(void 0, true);
    switch (e6.kind) {
      case "keys":
        return a2(n3, false);
      case "values":
  ...
  if (t2("keys"), t2("values"), t2("entries"), !s2 && u2 && "values" !== f2.name)
    try {
...
function qr() {
  ...
  return (b2 || D2 || E2 || c2 || d2) && (h2 = function(e6) {
    ...
    if (x2)
      return x2.lastIndex = w2.lastIndex, t3 = n2(h2, x2, A2), w2.lastIndex = x2.lastIndex, t3;
    ...
    if (N2 && (B2 = m2(B2, "y", ""), -1 === v2(B2, "g") && (B2 += "g"), F2 = y2(A2, w2.lastIndex), w2.lastIndex > 0 && (!w2.multiline || w2.multiline && "\n" !== g2(A2, w2.lastIndex - 1)) && (T2 = "(?: " + T2 + ")", F2 = " " + F2, k2++), r3 = new RegExp("^(?:" + T2 + ")", B2)), D2 && (r3 = new RegExp("^" + T2 + "$(?!\\s)", B2)), b2 && (a3 = w2.lastIndex), s3 = n2(p2, N2 ? r3 : w2, F2), N2 ? s3 ? (s3.input = y2(s3.input, k2), s3[0] = y2(s3[0], k2), s3.index = w2.lastIndex, w2.lastIndex += s3[0].length) : w2.lastIndex = 0 : b2 && s3 && (w2.lastIndex = w2.global ? s3.index + s3[0].length : a3), D2 && s3 && s3.length > 1 && n2(f2, s3[0], r3, function() {
      for (c3 = 1; c3 < arguments.length - 2; c3++)
        void 0 === arguments[c3] && (s3[c3] = void 0);
    }), s3 && O2)
      for (s3.groups = d3 = u2(null), c3 = 0; c3 < O2.length; c3++)
        d3[(C2 = O2[c3])[0]] = s3[C2[1]];
    return s3;
  }), zr = h2;
}
function Kr() {
...
function ho() {
  ...
  var e5 = Ht(), t2 = de(), n2 = $t(), r2 = function() {
    ...
    var e6 = B(), t3 = C(), n3 = e6.RegExp, r3 = !t3(function() {
      ...
      for (var s2 in e7 && (a2.hasIndices = "d"), a2)
        i3(s2, a2[s2]);
...
function Wo() {
  ...
  var e5 = ln(), t2 = function() {
    ...
    return mo = function(e7, r4) {
      if (i2 && "string" == typeof e7 && !t3.prepareStackTrace)
        for (; r4--; )
          e7 = n3(e7, o2, "");
      return e7;
    };
...
function Ko() {
  ...
  return Bo = function(i2) {
    if (!n2(i2))
      return t2(i2, o2) || t2(i2, "@@iterator") || r2[e5(i2)];
  };
}
function Yo() {
  if (Fo)
...
function Zo() {
  ...
  return _o = function(p2, h2, g2) {
    ...
    if (A2)
      ...
      if (!(m2 = u2(p2)))
        throw new c2(r2(p2) + " is not iterable");
      if (o2(m2)) {
        for (y2 = 0, b2 = i2(p2); b2 > y2; y2++)
          if ((E2 = T2(p2[y2])) && a2(f2, E2))
            return E2;
        return new d2(false);
      }
      v2 = s2(p2, m2);
    ...
    for (C2 = A2 ? p2.next : v2.next; !(D2 = t2(C2, v2)).done; ) {
      ...
      if ("object" == typeof E2 && E2 && a2(f2, E2))
        return E2;
    }
    return new d2(false);
  }, _o;
...
if (function() {
  ...
  global && (null === (ui = global.navigator) || void 0 === ui ? void 0 : ui.userAgent.match("QQBrowser")) && (fi(), pi());
function fi() {
...
function Ka() {
  ...
  return Oa = function(o2, i2) {
    var a2, s2;
    if ("string" === i2 && t2(a2 = o2.toString) && !n2(s2 = e5(a2, o2)))
      return s2;
    if (t2(a2 = o2.valueOf) && !n2(s2 = e5(a2, o2)))
      return s2;
    if ("string" !== i2 && t2(a2 = o2.toString) && !n2(s2 = e5(a2, o2)))
      return s2;
...
function Fs() {
  ...
  return cs = function(s2, u2) {
    ...
    var l2, c2 = r2(s2, a2);
    if (c2) {
      if (void 0 === u2 && (u2 = "default"), l2 = e5(c2, s2, u2), !t2(l2) || n2(l2))
        return l2;
...
function Pu() {
  ...
  return ou = function(t2) {
    if (t2 > 9007199254740991)
      throw e5("Maximum allowed index exceeded");
    return t2;
  };
}
function _u() {
...
function fc() {
  ...
  var e5 = Ms(), t2 = _i(), n2 = Fa(), r2 = Ns(), o2 = Iu(), i2 = zu(), a2 = t2([].push), s2 = function(t3) {
    ...
    return function(h2, g2, v2, m2) {
      for (var y2, b2, E2 = r2(h2), C2 = n2(E2), D2 = o2(C2), w2 = e5(g2, v2), S2 = 0, A2 = m2 || i2, x2 = s3 ? A2(h2, D2) : u2 || f2 ? A2(h2, 0) : void 0; D2 > S2; S2++)
        if ((p2 || S2 in C2) && (b2 = w2(y2 = C2[S2], S2, E2), t3))
          if (s3)
            x2[S2] = b2;
          else if (b2)
            switch (t3) {
...
function Nc() {
  return xc || (xc = 1, function() {
    ...
    a2 || (U2 = function() {
      if (l2(V2, this))
        throw new G2("Symbol is not a constructor");
    ...
    e5({ target: "Symbol", stat: true, forced: !i2 }, { keyFor: function(e6) {
      if (!n2(e6))
        throw new TypeError(r2(e6) + " is not a symbol");
      if (t2(a2, e6))
        return a2[e6];
    } });
  }(), function() {
    ...
    var e5 = Nu(), t2 = Ma(), n2 = Pi(), r2 = Wi(), o2 = _i(), i2 = Fi(), a2 = Mi(), s2 = Va(), u2 = kl(), l2 = Sc(), c2 = $a(), d2 = String, f2 = t2("JSON", "stringify"), p2 = o2(/./.exec), h2 = o2("".charAt), g2 = o2("".charCodeAt), v2 = o2("".replace), m2 = o2(1.1.toString), y2 = /[\uD800-\uDFFF]/g, b2 = /^[\uD800-\uDBFF]$/, E2 = /^[\uDC00-\uDFFF]$/, C2 = !c2 || i2(function() {
      ...
      if (a2(i3) || void 0 !== e6 && !s2(e6))
        return o3[1] = function(e7, t4) {
          if (a2(i3) && (t4 = r2(i3, this, d2(e7), t4)), !s2(t4))
            return t4;
        }, n2(f2, null, o3);
  ...
  return ed ? Qc : (ed = 1, function() {
    ...
    e5({ target: "Array", proto: true, arity: 1, forced: !p2 || !l2("concat") }, { concat: function(e6) {
      ...
      for (t3 = -1, r3 = arguments.length; t3 < r3; t3++)
        if (h2(c3 = -1 === t3 ? d3 : arguments[t3]))
          for (l3 = i2(c3), a2(p3 + l3), n3 = 0; n3 < l3; n3++, p3++)
            n3 in c3 && s2(f3, p3, c3[n3]);
        else
          a2(p3 + 1), s2(f3, p3++, c3);
...
function vf() {
  if (hf)
    return pf;
  hf = 1;
  for (var e5 = Os(), t2 = Ma(), n2 = _i(), r2 = Va(), o2 = ks(), i2 = t2("Symbol"), a2 = i2.isWellKnownSymbol, s2 = t2("Object", "getOwnPropertyNames"), u2 = n2(i2.prototype.valueOf), l2 = e5("wks"), c2 = 0, d2 = s2(i2), f2 = d2.length; c2 < f2; c2++)
    try {
      var p2 = d2[c2];
      r2(i2[p2]) && o2(p2);
    } catch (e6) {
  ...
  return pf = function(e6) {
    if (a2 && a2(e6))
      return true;
    try {
      for (var t3 = u2(e6), n3 = 0, r3 = s2(l2), o3 = r3.length; n3 < o3; n3++)
        if (l2[r3[n3]] == t3)
          return true;
    } catch (e7) {
    }
...
function ip(e5) {
  for (var t2 = arguments.length, n2 = Array(t2 > 1 ? t2 - 1 : 0), r2 = 1; r2 < t2; r2++)
...
function Op(e5, t2, n2) {
  ...
  var r2 = t2[Wp];
  if (!r2)
    return up(t2, function(o3, i3) {
      return Np(e5, r2, t2, o3, i3, n2);
    }, true), t2;
  if (r2.A !== e5)
    return t2;
  if (!r2.P)
    return Bp(e5, r2.t, true), r2.t;
  if (!r2.I) {
    r2.I = true, r2.A._--;
...
function kp(e5, t2) {
  if (t2 in e5)
    for (var n2 = Object.getPrototypeOf(e5); n2; ) {
...
var Xp = { get: function(e5, t2) {
  ...
  if (null == r2 ? void 0 : r2.set)
    return r2.set.call(e5.k, n2), true;
  if (!e5.P) {
    var o2 = Tp(hp(e5), t2), i2 = null == o2 ? void 0 : o2[Wp];
    if (i2 && i2.t === n2)
      return e5.o[t2] = n2, e5.R[t2] = false, true;
    if (function(e6, t3) {
      return e6 === t3 ? 0 !== e6 || 1 / e6 == 1 / t3 : e6 != e6 && t3 != t3;
    }(n2, o2) && (void 0 !== n2 || cp(e5.t, t2)))
      return true;
    Ip(e5), Fp(e5);
  }
    ...
    this.O = $p, this.D = true, this.produce = function(e7, n2, r2) {
      if ("function" == typeof e7 && "function" != typeof n2) {
        ...
        return function(e8) {
          var t4 = this;
          void 0 === e8 && (e8 = o2);
          for (var r3 = arguments.length, a3 = Array(r3 > 1 ? r3 - 1 : 0), s3 = 1; s3 < r3; s3++)
      ...
      if ("function" == typeof e7)
        return function(n3) {
          for (var r3 = arguments.length, o3 = Array(r3 > 1 ? r3 - 1 : 0), i3 = 1; i3 < r3; i3++)
...
function ph(e5, t2) {
  ...
  var n2, r2, o2 = function(e6, t3) {
    ...
    for (r3 = 0; r3 < i3.length; r3++)
      n3 = i3[r3], t3.indexOf(n3) >= 0 || (o3[n3] = e6[n3]);
    return o3;
  }(e5, t2);
  if (Object.getOwnPropertySymbols) {
    var i2 = Object.getOwnPropertySymbols(e5);
    for (r2 = 0; r2 < i2.length; r2++)
      n2 = i2[r2], t2.indexOf(n2) >= 0 || Object.prototype.propertyIsEnumerable.call(e5, n2) && (o2[n2] = e5[n2]);
  }
  return o2;
}
var hh;
var gh = function(e5) {
  ...
  for (var u2 of r2) {
    ...
    if (!l2)
      break;
    var c2 = Ih(u2, l2);
    if ([o2, i2] = n2 ? [i2, c2] : [c2, o2], Ph(o2, hh.ZWJ) && Ph(i2, hh.ExtPict) && !Mh(n2 ? e5.substring(0, a2) : e5.substring(0, e5.length - a2)))
      break;
    if (Ph(o2, hh.RI) && Ph(i2, hh.RI) && !(s2 = null !== s2 ? !s2 : !!n2 || Hh(e5.substring(0, e5.length - a2))))
      break;
    if (o2 !== hh.None && i2 !== hh.None && Rh(o2, i2))
      break;
    a2 += u2.length;
  }
  return a2 || 1;
...
var Kh = { above(e5) {
  ...
  if (o2) {
    ...
    for (var [u2, l2] of Kh.levels(e5, { at: a2, voids: n2, match: i2, reverse: s2 }))
      if (!Cg.isText(u2) && !og.equals(a2, l2))
        return [u2, l2];
  }
}, addMark(e5, t2, n2) {
  e5.addMark(t2, n2);
  ...
  if (null == i2 && (i2 = () => true), n2) {
    ...
    for (var [u2, l2] of eg.levels(e5, s2))
      if (i2(u2, l2) && (a2.push([u2, l2]), !o2 && Kh.isVoid(e5, u2)))
        break;
  ...
  if (og.isPath(t2)) {
    ...
    var s2 = eg.get(e5, o2);
    if (!Cg.isText(s2))
      throw new Error("Cannot get the ".concat(r2, " point in the node at path [").concat(t2, "] because it has no ").concat(r2, " text node."));
  ...
  if (0 !== o2.offset || 0 !== i2.offset || fg.isCollapsed(t2))
    return t2;
  var a2 = Kh.above(e5, { at: i2, match: (t3) => Kh.isBlock(e5, t3) }), s2 = a2 ? a2[1] : [], u2 = { anchor: Kh.start(e5, o2), focus: i2 }, l2 = true;
  for (var [c2, d2] of Kh.nodes(e5, { at: u2, match: Cg.isText, reverse: true, voids: r2 }))
    if (l2)
      l2 = false;
...
var Yh = { isLocation: (e5) => og.isPath(e5) || ug.isPoint(e5) || fg.isRange(e5) };
...
var eg = { ancestor(e5, t2) {
  var n2 = eg.get(e5, t2);
  if (Cg.isText(n2))
    throw new Error("Cannot get the ancestor node at path [".concat(t2, "] because it refers to a text node instead: ").concat(gg.stringify(n2)));
  return n2;
}, *ancestors(e5, t2) {
  ...
  if (Cg.isText(e5))
    throw new Error("Cannot get the child of a text node: ".concat(gg.stringify(e5)));
  var n2 = e5.children[t2];
  if (null == n2)
    throw new Error("Cannot get child at index `".concat(t2, "` in node: ").concat(gg.stringify(e5)));
  return n2;
}, *children(e5, t2) {
  ...
  var n2 = eg.get(e5, t2);
  if (Kh.isEditor(n2))
    throw new Error("Cannot get the descendant node at path [".concat(t2, "] because it refers to the root editor node instead: ").concat(gg.stringify(n2)));
  return n2;
}, *descendants(e5) {
  var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
  for (var [n2, r2] of eg.nodes(e5, t2))
    0 !== r2.length && (yield [n2, r2]);
}, *elements(e5) {
  var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
  for (var [n2, r2] of eg.nodes(e5, t2))
    $h.isElement(n2) && (yield [n2, r2]);
  ...
  for (var n2 = t2.slice(), r2 = eg.get(e5, n2); r2 && !Cg.isText(r2) && 0 !== r2.children.length; )
    r2 = r2.children[0], n2.push(0);
  return [r2, n2];
}, fragment(e5, t2) {
  if (Cg.isText(e5))
    throw new Error("Cannot get a fragment starting from a root text node: ".concat(gg.stringify(e5)));
  ...
  for (var n2 = e5, r2 = 0; r2 < t2.length; r2++) {
    var o2 = t2[r2];
    if (Cg.isText(n2) || !n2.children[o2])
      throw new Error("Cannot find a descendant at path [".concat(t2, "] in node: ").concat(gg.stringify(e5)));
    n2 = n2.children[o2];
  }
  return n2;
}, has(e5, t2) {
  ...
  var n2 = eg.get(e5, t2);
  if (!Cg.isText(n2))
    throw new Error("Cannot get the leaf node at path [".concat(t2, "] because it refers to a non-leaf node: ").concat(gg.stringify(n2)));
  return n2;
}, *levels(e5, t2) {
  var n2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
  ...
  for (var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, { pass: n2, reverse: r2 = false } = t2, { from: o2 = [], to: i2 } = t2, a2 = /* @__PURE__ */ new Set(), s2 = [], u2 = e5; !i2 || !(r2 ? og.isBefore(s2, i2) : og.isAfter(s2, i2)); )
    if (a2.has(u2) || (yield [u2, s2]), a2.has(u2) || Cg.isText(u2) || 0 === u2.children.length || null != n2 && false !== n2([u2, s2])) {
      if (0 === s2.length)
        break;
      if (!r2) {
        var l2 = og.next(s2);
      ...
      if (r2 && 0 !== s2[s2.length - 1])
        s2 = og.previous(s2), u2 = eg.get(e5, s2);
      else
        s2 = og.parent(s2), u2 = eg.get(e5, s2), a2.add(u2);
    } else {
      a2.add(u2);
  ...
  if (Cg.isText(r2))
    throw new Error("Cannot get the parent of path [".concat(t2, "] because it does not exist in the root."));
  return r2;
}, string: (e5) => Cg.isText(e5) ? e5.text : e5.children.map(eg.string).join(""), *texts(e5) {
  var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
  for (var [n2, r2] of eg.nodes(e5, t2))
    Cg.isText(n2) && (yield [n2, r2]);
} };
function tg(e5, t2) {
  var n2 = Object.keys(e5);
  if (Object.getOwnPropertySymbols) {
...
var rg = { isNodeOperation: (e5) => rg.isOperation(e5) && e5.type.endsWith("_node"), isOperation(e5) {
  ...
  switch (e5.type) {
    ...
    case "move_node":
      ...
      if (og.equals(t2, n2))
        return e5;
      if (og.isSibling(n2, t2))
        return ng(ng({}, e5), {}, { path: t2, newPath: n2 });
...
var og = { ancestors(e5) {
  ...
  for (var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, { reverse: n2 = false } = t2, r2 = [], o2 = 0; o2 <= e5.length; o2++)
    r2.push(e5.slice(0, o2));
  return n2 && r2.reverse(), r2;
}, next(e5) {
  if (0 === e5.length)
    throw new Error("Cannot get the next path of a root path [".concat(e5, "], because it has no next index."));
  ...
  if (0 === e5.length)
    throw new Error("Cannot get the parent path of the root path [".concat(e5, "]."));
  return e5.slice(0, -1);
}, previous(e5) {
  if (0 === e5.length)
    throw new Error("Cannot get the previous path of a root path [".concat(e5, "], because it has no previous index."));
  var t2 = e5[e5.length - 1];
  if (t2 <= 0)
    throw new Error("Cannot get the previous path of a first child path [".concat(e5, "] because it would result in a negative index."));
  return e5.slice(0, -1).concat(t2 - 1);
}, relative(e5, t2) {
  if (!og.isAncestor(t2, e5) && !og.equals(e5, t2))
    throw new Error("Cannot get the relative path of [".concat(e5, "] inside ancestor [").concat(t2, "], because it is not above or equal to the path."));
  ...
  return eh(e5, (r2) => {
    ...
    if (e5 && 0 !== (null == e5 ? void 0 : e5.length)) {
      ...
      switch (t2.type) {
        ...
        case "remove_node":
          var { path: a2 } = t2;
          if (og.equals(a2, r2) || og.isAncestor(a2, r2))
            return null;
        ...
        case "split_node":
          ...
          if (og.equals(l2, r2)) {
            ...
            og.endsBefore(l2, r2) ? r2[l2.length - 1] += 1 : og.isAncestor(l2, r2) && e5[l2.length] >= c2 && (r2[l2.length - 1] += 1, r2[l2.length] -= c2);
          break;
        case "move_node":
  ...
  return eh(e5, (e6) => {
    ...
    switch (t2.type) {
      ...
      case "remove_text":
        ...
        break;
      case "remove_node":
        if (og.equals(t2.path, o2) || og.isAncestor(t2.path, o2))
          return null;
        e6.path = og.transform(o2, t2, n2);
        break;
      case "split_node":
        if (og.equals(t2.path, o2)) {
          if (t2.position === i2 && null == r2)
            return null;
...
var fg = { edges(e5) {
  ...
  if (fg.isRange(t2)) {
    if (fg.includes(e5, t2.anchor) || fg.includes(e5, t2.focus))
      return true;
  ...
  return eh(e5, (e6) => {
    ...
    if ("inward" === i2) {
      ...
      "outward" === i2 ? fg.isForward(e6) ? (r2 = "backward", o2 = "forward") : (r2 = "forward", o2 = "backward") : (r2 = i2, o2 = i2);
...
var Cg = { equals(e5, t2) {
  ...
  for (var n2 in t2)
    if ("text" !== n2 && (!e5.hasOwnProperty(n2) || e5[n2] !== t2[n2]))
      return false;
  return true;
}, decorations(e5, t2) {
  var n2 = [Eg({}, e5)];
  for (var r2 of t2) {
    ...
    for (var d2 of n2) {
      ...
      if (u2 += f2, l2 <= p2 && u2 <= c2)
        Object.assign(d2, o2), s2.push(d2);
      else if (l2 !== c2 && (l2 === u2 || c2 === p2) || l2 > u2 || c2 < p2 || c2 === p2 && 0 !== p2)
        s2.push(d2);
      else {
    ...
    n2 = ((e6, t3, n3) => {
      switch (n3.type) {
        case "insert_node":
          ...
          if (i2.children.splice(a2, 0, o2), t3)
            for (var [s2, u2] of fg.points(t3))
              t3[u2] = ug.transform(s2, n3);
          break;
        case "insert_text":
          ...
          if (f2.text = p2 + d2 + h2, t3)
            for (var [g2, v2] of fg.points(t3))
              t3[v2] = ug.transform(g2, n3);
          break;
        case "merge_node":
          var { path: m2 } = n3, y2 = eg.get(e6, m2), b2 = og.previous(m2), E2 = eg.get(e6, b2), C2 = eg.parent(e6, m2), D2 = m2[m2.length - 1];
          if (Cg.isText(y2) && Cg.isText(E2))
            E2.text += y2.text;
          else {
            if (Cg.isText(y2) || Cg.isText(E2))
              throw new Error('Cannot apply a "merge_node" operation at path ['.concat(m2, "] to nodes of different interfaces: ").concat(gg.stringify(y2), " ").concat(gg.stringify(E2)));
            E2.children.push(...y2.children);
          }
          if (C2.children.splice(D2, 1), t3)
            for (var [w2, S2] of fg.points(t3))
              t3[S2] = ug.transform(w2, n3);
          break;
        case "move_node":
          var { path: A2, newPath: x2 } = n3;
          if (og.isAncestor(A2, x2))
            throw new Error("Cannot move a path [".concat(A2, "] to new path [").concat(x2, "] because the destination is inside itself."));
          ...
          if (k2.children.splice(F2, 0, O2), t3)
            for (var [I2, P2] of fg.points(t3))
              t3[P2] = ug.transform(I2, n3);
          break;
        case "remove_node":
          var { path: _2 } = n3, R2 = _2[_2.length - 1];
          if (eg.parent(e6, _2).children.splice(R2, 1), t3)
            for (var [L2, M2] of fg.points(t3)) {
        ...
        case "remove_text":
          ...
          if (K2.text = Y2 + X2, t3)
            for (var [Z2, J2] of fg.points(t3))
              t3[J2] = ug.transform(Z2, n3);
          break;
        case "set_node":
        ...
        case "set_selection":
          ...
          if (null == ae2)
            ...
            if (null == t3) {
              if (!fg.isRange(ae2))
                throw new Error('Cannot apply an incomplete "set_selection" operation properties '.concat(gg.stringify(ae2), " when there is no current selection."));
              t3 = wg({}, ae2);
            }
            for (var se2 in ae2) {
              var ue2 = ae2[se2];
              if (null == ue2) {
                if ("anchor" === se2 || "focus" === se2)
                  throw new Error('Cannot remove the "'.concat(se2, '" selection property'));
                delete t3[se2];
              } else
                t3[se2] = ue2;
            }
        ...
        case "split_node":
          ...
          if (he2.children.splice(ge2 + 1, 0, fe2), t3)
            for (var [Ee2, Ce2] of fg.points(t3))
              t3[Ce2] = ug.transform(Ee2, n3);
      }
      return t3;
    })(e5, n2, t2);
  } finally {
...
var Bg = { insertNodes(e5, t2) {
  ...
  Kh.withoutNormalizing(e5, () => {
    ...
    if (eg.isNode(t2) && (t2 = [t2]), 0 !== t2.length) {
      var [l2] = t2;
      if (a2 || (a2 = e5.selection ? e5.selection : e5.children.length > 0 ? Kh.end(e5, []) : [0], u2 = true), null == u2 && (u2 = false), fg.isRange(a2))
        if (r2 || (a2 = Kh.unhangRange(e5, a2)), fg.isCollapsed(a2))
          a2 = a2.anchor;
        else {
  ...
  Kh.withoutNormalizing(e5, () => {
    ...
    if (null == i2 && (i2 = og.isPath(n2) ? Fg(e5, n2) : (t3) => Kh.isBlock(e5, t3)), n2) {
      ...
      for (var u2 of s2) {
        var l2 = u2.unref();
        if (l2.length < 2)
          throw new Error("Cannot lift node at a path [".concat(l2, "] because it has a depth of less than `2`."));
        ...
        if (1 === h2) {
          ...
          jg.moveNodes(e5, { at: l2, to: f2, voids: o2 });
        else if (p2 === h2 - 1) {
          var v2 = og.next(f2);
    ...
    if (r2) {
      if (null == n2)
        if (og.isPath(r2)) {
          ...
          n2 = (t3) => Kh.isBlock(e5, t3);
      if (!o2 && fg.isRange(r2) && (r2 = Kh.unhangRange(e5, r2)), fg.isRange(r2))
      ...
      if (c2 && d2) {
        ...
        if (0 !== p2.length && 0 !== g2.length) {
          ...
          if (Cg.isText(f2) && Cg.isText(h2)) {
            ...
            if (!$h.isElement(f2) || !$h.isElement(h2))
              throw new Error("Cannot merge the node at path [".concat(p2, "] with the previous sibling because it is not the same kind: ").concat(gg.stringify(f2), " ").concat(gg.stringify(h2)));
            S2 = ph(f2, xg);
  ...
  Kh.withoutNormalizing(e5, () => {
    ...
    if (o2) {
      if (null == r2 && (r2 = og.isPath(o2) ? Fg(e5, o2) : (t3) => Kh.isBlock(e5, t3)), !s2 && fg.isRange(o2) && (o2 = Kh.unhangRange(e5, o2)), l2 && fg.isRange(o2)) {
        if (fg.isCollapsed(o2) && Kh.leaf(e5, o2.anchor)[0].text.length > 0)
          return;
      ...
      for (var [m2, y2] of (i2 || (i2 = (e6, t3) => e6 !== t3), Kh.nodes(e5, { at: o2, match: r2, mode: u2, voids: c2 }))) {
        ...
        if (0 !== y2.length) {
          var C2 = false;
          for (var D2 in t2)
            "children" !== D2 && "text" !== D2 && i2(t2[D2], m2[D2]) && (C2 = true, m2.hasOwnProperty(D2) && (b2[D2] = m2[D2]), a2 ? null != t2[D2] && (E2[D2] = a2(m2[D2], t2[D2])) : null != t2[D2] && (E2[D2] = t2[D2]));
    ...
    if (i2) {
      ...
      try {
        ...
        for (var [w2, S2] of Kh.levels(e5, { at: C2, reverse: true, voids: r2 })) {
          var A2 = false;
          if (S2.length < E2.length || 0 === S2.length || !r2 && Kh.isVoid(e5, w2))
            break;
...
var _g = { collapse(e5) {
  ...
  if (r2) {
    if ("anchor" === n2)
      jg.select(e5, r2.anchor);
    else if ("focus" === n2)
      jg.select(e5, r2.focus);
    else if ("start" === n2) {
      var [o2] = fg.edges(r2);
      jg.select(e5, o2);
    } else if ("end" === n2) {
  ...
  var { selection: n2 } = e5;
  if (t2 = Kh.range(e5, t2), n2)
    jg.setSelection(e5, t2);
  else {
    if (!fg.isRange(t2))
      throw new Error("When setting the selection and the current selection is `null` you must provide at least an `anchor` and `focus`, but you passed: ".concat(gg.stringify(t2)));
  ...
  if (n2) {
    for (var i2 in t2)
      ("anchor" === i2 && null != t2.anchor && !ug.equals(t2.anchor, n2.anchor) || "focus" === i2 && null != t2.focus && !ug.equals(t2.focus, n2.focus) || "anchor" !== i2 && "focus" !== i2 && t2[i2] !== n2[i2]) && (r2[i2] = n2[i2], o2[i2] = t2[i2]);
...
var Rg = { delete(e5) {
  ...
  Kh.withoutNormalizing(e5, () => {
    ...
    if (a2) {
      ...
      if (og.isPath(a2))
        jg.removeNodes(e5, { at: a2, voids: i2 });
  ...
  Kh.withoutNormalizing(e5, () => {
    ...
    if (t2.length && i2) {
      ...
      if (o2 || !Kh.void(e5, { at: i2 })) {
        ...
        for (var C2 of eg.nodes({ children: t2 }, { pass: E2 }))
          E2(C2) && b2.push(C2);
        var D2 = [], w2 = [], S2 = [], A2 = true, x2 = false;
        for (var [O2] of b2)
          $h.isElement(O2) && !e5.isInline(O2) ? (A2 = false, x2 = true, w2.push(O2)) : A2 ? D2.push(O2) : S2.push(O2);
  ...
  Kh.withoutNormalizing(e5, () => {
    ...
    if (o2) {
      if (og.isPath(o2) && (o2 = Kh.range(e5, o2)), fg.isRange(o2))
        if (fg.isCollapsed(o2))
          o2 = o2.anchor;
        else {
          var i2 = fg.end(o2);
          if (!r2 && Kh.void(e5, { at: i2 }))
            return;
...
var Vg = (e5) => {
  ...
  return t2.history = { undos: [], redos: [] }, t2.redo = () => {
    ...
    if (null == u2 && (u2 = Gg(e6)), u2) {
      if (null == l2 && (l2 = null != a2 && (0 !== r2.length || Wg(e6, s2))), a2 && l2)
        a2.operations.push(e6);
      else {
...
var qg = function(e5, t2) {
  return qg = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e6, t3) {
    ...
    for (var n2 in t3)
      Object.prototype.hasOwnProperty.call(t3, n2) && (e6[n2] = t3[n2]);
  }, qg(e5, t2);
};
function Kg(e5, t2) {
  ...
  return Yg = Object.assign || function(e5) {
    for (var t2, n2 = 1, r2 = arguments.length; n2 < r2; n2++)
      for (var o2 in t2 = arguments[n2])
        Object.prototype.hasOwnProperty.call(t2, o2) && (e5[o2] = t2[o2]);
    return e5;
    ...
    return function(u2) {
      return function(s4) {
        ...
        for (; a2 && (a2 = 0, s4[0] && (i2 = 0)), i2; )
          try {
            if (n2 = 1, r2 && (o2 = 2 & s4[0] ? r2.return : s4[0] ? r2.throw || ((o2 = r2.return) && o2.call(r2), 0) : r2.next) && !(o2 = o2.call(r2, s4[1])).done)
              return o2;
...
var av = (nv || (nv = 1, function(e5, t2) {
  ...
  function $2(e6, t3, n3, r3) {
    for (var o3 = -1, i3 = e6 ? e6.length : 0; ++o3 < i3; )
      n3 = t3(n3, e6[o3], o3, e6);
    return n3;
  }
  function U2(e6) {
    var t3 = false;
    if (null != e6 && "function" != typeof e6.toString)
      try {
        t3 = !!(e6 + "");
      } catch (e7) {
      }
  ...
  function Be2(e6, t3) {
    var n3 = Ve2(e6) || function(e7) {
      ...
      for (var n4 = -1, r4 = Array(e7); ++n4 < e7; )
        r4[n4] = t4(n4);
      return r4;
    }(e6.length, String) : [], r3 = n3.length, i3 = !!r3;
    for (var a3 in e6)
      !Q2.call(e6, a3) || i3 && ("length" == a3 || He2(a3, r3)) || n3.push(a3);
    return n3;
  }
  ...
  function Fe2(e6, t3, n3, r3, f3, m3, y2) {
    var k3;
    if (r3 && (k3 = m3 ? r3(e6, f3, m3, y2) : r3(e6)), void 0 !== k3)
      return k3;
    if (!Ke2(e6))
      return e6;
    var F3 = Ve2(e6);
    ...
    if (R3)
      return R3;
    if (y2.set(e6, k3), !F3)
      var L3 = n3 ? function(e7) {
        return function(e8, t4, n4) {
          var r4 = t4(e8);
          return Ve2(e8) ? r4 : function(e9, t5) {
            for (var n5 = -1, r5 = t5.length, o3 = e9.length; ++n5 < r5; )
              e9[o3 + n5] = t5[n5];
            return e9;
          }(r4, n4(e8));
        }(e7, Ye2, Me2);
  ...
  Ae2.prototype.clear = function() {
    ...
    if (n3 instanceof xe2) {
      var r3 = n3.__data__;
      if (!pe2 || r3.length < 199)
        return r3.push([e6, t3]), this;
  ...
  function Ye2(e6) {
    return We2(e6) ? Be2(e6) : function(e7) {
      if (!ze2(e7))
        return de2(e7);
      var t3 = [];
      for (var n3 in Object(e7))
        Q2.call(e7, n3) && "constructor" != n3 && t3.push(n3);
      return t3;
    }(e6);
  }
...
var uv = function() {
  ...
  function p2(e6, n3) {
    ...
    for (var a3 in e6)
      !l2.call(e6, a3) || i3 && ("length" == a3 || y2(a3, o3)) || r3.push(a3);
    return r3;
  }
  ...
  function m2(e6) {
    if (n3 = (t3 = e6) && t3.constructor, r3 = "function" == typeof n3 && n3.prototype || u2, t3 !== r3)
      return f2(e6);
    var t3, n3, r3, o3 = [];
    for (var i3 in Object(e6))
      l2.call(e6, i3) && "constructor" != i3 && o3.push(i3);
    return o3;
  }
  function y2(t3, n3) {
...
function Ev(e5, t2) {
  ...
  if (null != bv[n2])
    throw new Error("Duplicated key '".concat(n2, "' in menu items"));
...
function am(e5, t2) {
  ...
  if ("string" == typeof e5) {
    ...
    if (n3.indexOf("<") >= 0 && n3.indexOf(">") >= 0) {
      ...
      t3.innerHTML = n3;
      for (let e7 = 0; e7 < t3.childNodes.length; e7 += 1)
        o2.push(t3.childNodes[e7]);
    } else
      o2 = function(e6, t3) {
        if ("string" != typeof e6)
          return [e6];
        const n4 = [], r3 = t3.querySelectorAll(e6);
        for (let e7 = 0; e7 < r3.length; e7 += 1)
          n4.push(r3[e7]);
        return n4;
      }(e5.trim(), t2 || r2);
  } else if (e5.nodeType || e5 === n2 || e5 === r2)
    o2.push(e5);
  ...
  return new nm(function(e6) {
    const t3 = [];
    for (let n3 = 0; n3 < e6.length; n3 += 1)
      -1 === t3.indexOf(e6[n3]) && t3.push(e6[n3]);
    return t3;
  }(o2));
}
function sm(...e5) {
...
function cm(e5, t2) {
  if (1 === arguments.length && "string" == typeof e5)
    return this[0] ? this[0].getAttribute(e5) : void 0;
  for (let n2 = 0; n2 < this.length; n2 += 1)
    if (2 === arguments.length)
      this[n2].setAttribute(e5, t2);
    else
      for (const t3 in e5)
        this[n2][t3] = e5[t3], this[n2].setAttribute(t3, e5[t3]);
  return this;
}
function dm(e5) {
  for (let t2 = 0; t2 < this.length; t2 += 1)
    this[t2].removeAttribute(e5);
  return this;
}
function fm(e5, t2) {
  let n2;
  if (void 0 === t2) {
    if (n2 = this[0], !n2)
      return;
    if (n2.dom7ElementDataStorage && e5 in n2.dom7ElementDataStorage)
      return n2.dom7ElementDataStorage[e5];
    const t3 = n2.getAttribute(`data-${e5}`);
    return t3 || void 0;
  }
  for (let r2 = 0; r2 < this.length; r2 += 1)
    n2 = this[r2], n2.dom7ElementDataStorage || (n2.dom7ElementDataStorage = {}), n2.dom7ElementDataStorage[e5] = t2;
  return this;
}
function pm() {
  const e5 = this[0];
  ...
  const t2 = {};
  if (e5.dataset)
    for (const n2 in e5.dataset)
      t2[n2] = e5.dataset[n2];
  else
    for (let n2 = 0; n2 < e5.attributes.length; n2 += 1) {
      const r2 = e5.attributes[n2];
      r2.name.indexOf("data-") >= 0 && (t2[im(r2.name.split("data-")[1])] = r2.value);
    }
  for (const e6 in t2)
    "false" === t2[e6] ? t2[e6] = false : "true" === t2[e6] ? t2[e6] = true : parseFloat(t2[e6]) === 1 * t2[e6] && (t2[e6] *= 1);
  return t2;
}
function hm(e5) {
  if (void 0 === e5) {
    ...
    if (e6.multiple && "select" === e6.nodeName.toLowerCase()) {
      const t2 = [];
      for (let n2 = 0; n2 < e6.selectedOptions.length; n2 += 1)
        t2.push(e6.selectedOptions[n2].value);
      return t2;
    }
    return e6.value;
  }
  for (let t2 = 0; t2 < this.length; t2 += 1) {
    const n2 = this[t2];
    if (Array.isArray(e5) && n2.multiple && "select" === n2.nodeName.toLowerCase())
      for (let t3 = 0; t3 < n2.options.length; t3 += 1)
        n2.options[t3].selected = e5.indexOf(n2.options[t3].value) >= 0;
    else
      n2.value = e5;
  }
  return this;
...
function gm(...e5) {
  ...
  function i2(e6) {
    ...
    if (o3.indexOf(e6) < 0 && o3.unshift(e6), am(t3).is(n2))
      r2.apply(t3, o3);
    else {
      const e7 = am(t3).parents();
      for (let t4 = 0; t4 < e7.length; t4 += 1)
        am(e7[t4]).is(n2) && r2.apply(e7[t4], o3);
    }
  }
  function a2(e6) {
...
function vm(...e5) {
  ...
  for (let e6 = 0; e6 < i2.length; e6 += 1) {
    ...
    for (let e7 = 0; e7 < this.length; e7 += 1) {
      const i3 = this[e7];
      let a2;
      if (!n2 && i3.dom7Listeners ? a2 = i3.dom7Listeners[t3] : n2 && i3.dom7LiveListeners && (a2 = i3.dom7LiveListeners[t3]), a2 && a2.length)
        for (let e8 = a2.length - 1; e8 >= 0; e8 -= 1) {
          const n3 = a2[e8];
...
function Dm(e5, t2) {
  ...
  if (1 === arguments.length) {
    if ("string" != typeof e5) {
      for (r2 = 0; r2 < this.length; r2 += 1)
        for (const t3 in e5)
          this[r2].style[t3] = e5[t3];
      return this;
    }
    if (this[0])
      return n2.getComputedStyle(this[0], null).getPropertyValue(e5);
  }
...
function Om(e5) {
  ...
  if ("string" == typeof e5) {
    if (r2.matches)
      return r2.matches(e5);
    if (r2.webkitMatchesSelector)
      return r2.webkitMatchesSelector(e5);
    if (r2.msMatchesSelector)
      return r2.msMatchesSelector(e5);
    for (o2 = am(e5), i2 = 0; i2 < o2.length; i2 += 1)
      if (o2[i2] === r2)
        return true;
    return false;
  }
  ...
  if (e5.nodeType || e5 instanceof nm) {
    for (o2 = e5.nodeType ? [e5] : e5, i2 = 0; i2 < o2.length; i2 += 1)
      if (o2[i2] === r2)
        return true;
    return false;
  }
  ...
  for (let r2 = 0; r2 < e5.length; r2 += 1) {
    ...
    for (let e6 = 0; e6 < this.length; e6 += 1)
      if ("string" == typeof t2) {
        ...
        for (r3.innerHTML = t2; r3.firstChild; )
          this[e6].appendChild(r3.firstChild);
      } else if (t2 instanceof nm)
        for (let n3 = 0; n3 < t2.length; n3 += 1)
          this[e6].appendChild(t2[n3]);
      else
        this[e6].appendChild(t2);
  }
  return this;
}
function Bm(e5) {
  const t2 = Qv();
  let n2, r2;
  for (n2 = 0; n2 < this.length; n2 += 1)
    if ("string" == typeof e5) {
      const o2 = t2.createElement("div");
      for (o2.innerHTML = e5, r2 = o2.childNodes.length - 1; r2 >= 0; r2 -= 1)
        this[n2].insertBefore(o2.childNodes[r2], this[n2].childNodes[0]);
    } else if (e5 instanceof nm)
      for (r2 = 0; r2 < e5.length; r2 += 1)
        this[n2].insertBefore(e5[r2], this[n2].childNodes[0]);
    else
      this[n2].insertBefore(e5, this[n2].childNodes[0]);
  return this;
}
function Tm(e5) {
  const t2 = [];
  for (let n2 = 0; n2 < this.length; n2 += 1)
    null !== this[n2].parentNode && (e5 ? am(this[n2].parentNode).is(e5) && t2.push(this[n2].parentNode) : t2.push(this[n2].parentNode));
  return am(t2);
}
function km(e5) {
  const t2 = [];
  for (let n2 = 0; n2 < this.length; n2 += 1) {
    ...
    for (; r2; )
      e5 ? am(r2).is(e5) && t2.push(r2) : t2.push(r2), r2 = r2.parentNode;
  }
  return am(t2);
}
function Fm(e5) {
...
function Im(e5) {
  ...
  for (let n2 = 0; n2 < this.length; n2 += 1) {
    ...
    for (let n3 = 0; n3 < r2.length; n3 += 1)
      e5 && !am(r2[n3]).is(e5) || t2.push(r2[n3]);
  }
  return am(t2);
}
function Pm() {
  for (let e5 = 0; e5 < this.length; e5 += 1)
    this[e5].parentNode && this[e5].parentNode.removeChild(this[e5]);
  return this;
}
function _m() {
  for (let e5 = 0; e5 < this.length; e5 += 1) {
    const t2 = this[e5];
    if (1 === t2.nodeType) {
      for (let e6 = 0; e6 < t2.childNodes.length; e6 += 1)
        t2.childNodes[e6].parentNode && t2.childNodes[e6].parentNode.removeChild(t2.childNodes[e6]);
      t2.textContent = "";
    }
  }
  return this;
  ...
  return function(...t2) {
    if (void 0 === t2[0]) {
      for (let t3 = 0; t3 < this.length; t3 += 1)
        Rm.indexOf(e5) < 0 && (e5 in this[t3] ? this[t3][e5]() : am(this[t3]).trigger(e5));
      return this;
    }
...
var zm = (e5 = 21) => {
  ...
  for (; e5--; )
    t2 += "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict"[63 & n2[e5]];
  return t2;
};
function $m(e5) {
...
var Qm = function(e5, t2, n2) {
  for (var r2 = e5.childNodes, o2 = r2[t2], i2 = t2, a2 = false, s2 = false; (Km(o2) || Ym(o2) && 0 === o2.childNodes.length || Ym(o2) && "false" === o2.getAttribute("contenteditable")) && (!a2 || !s2); )
    i2 >= r2.length ? (a2 = true, i2 = t2 - 1, n2 = "backward") : i2 < 0 ? (s2 = true, i2 = t2 + 1, n2 = "forward") : (o2 = r2[i2], t2 = i2, i2 += "forward" === n2 ? 1 : -1);
  return [o2, t2];
};
...
function ny(e5, t2) {
  if (!Gm(e5) || "true" !== e5.dataset.slateVoid)
    for (var n2 = e5.childNodes, r2 = n2.length; r2 -= 1; ) {
...
function fy(e5, t2) {
  var n2 = function(e6, t3) {
    var n3 = [];
    if (null != e6.attr("data-w-e-is-void"))
      return n3;
...
function hy(e5, t2) {
  ...
  if ("code" === n2)
    return "pre" === ry(e5.parent()) ? fy(e5, t2) : py(e5, t2);
  if (ay.includes(n2)) {
...
var Sy = function() {
  ...
  function T2(e6, t3) {
    return function(e7, t4) {
      for (var n3 = -1, r3 = e7 ? e7.length : 0, o3 = Array(r3); ++n3 < r3; )
        o3[n3] = t4(e7[n3], n3, e7);
      return o3;
    }(t3, function(t4) {
      return e6[t4];
    });
  ...
  function oe2(e6, n3) {
    ...
    for (var a3 in e6)
      !z2.call(e6, a3) || i3 && ("length" == a3 || le2(a3, o3)) || r3.push(a3);
    return r3;
  }
  function ie2(e6) {
    ...
    var t3 = pe2(e6) || function(e7) {
      var t4 = false;
      if (null != e7 && "function" != typeof e7.toString)
        try {
          t4 = !!(e7 + "");
        } catch (e8) {
        }
  ...
  function ae2(e6) {
    if (n3 = (t3 = e6) && t3.constructor, r3 = "function" == typeof n3 && n3.prototype || L2, t3 !== r3)
      return q2(e6);
    var t3, n3, r3, o3 = [];
    for (var i3 in Object(e6))
      z2.call(e6, i3) && "constructor" != i3 && o3.push(i3);
    return o3;
  }
  function se2(e6, t3) {
    var n3 = function(e7, t4) {
  ...
  return by = function(e6) {
    ...
    if (fe2(e6))
      return function(e7) {
        ...
        for (t4 || (t4 = Array(r3)); ++n3 < r3; )
          t4[n3] = e7[n3];
        return t4;
      }(e6);
    if (W2 && e6[W2])
      return function(e7) {
        for (var t4, n3 = []; !(t4 = e7.next()).done; )
          n3.push(t4.value);
        return n3;
      }(e6[W2]());
    var t3 = ue2(e6);
...
var _y = { getWindow: function(e5) {
  ...
  if (!n2)
    throw new Error("Cannot resolve a DOM node from Slate node: ".concat(JSON.stringify(t2)));
  return n2;
  ...
  try {
    ...
    if (e6 instanceof Error && !e6.message.includes('Permission denied to access property "nodeType"'))
      throw e6;
  }
  ...
  if (!o2)
    throw new Error("Cannot resolve a DOM point from Slate point: ".concat(JSON.stringify(t2)));
  return o2;
  ...
  if (!r2)
    throw new Error("Cannot resolve a Slate node from DOM node: ".concat(n2));
  return r2;
}, findEventRange: function(e5, t2) {
  "nativeEvent" in t2 && (t2 = t2.nativeEvent);
  var n2 = t2.clientX, r2 = t2.clientY, o2 = t2.target;
  if (null == n2 || null == r2)
    throw new Error("Cannot resolve a Slate range from a DOM event: ".concat(t2));
  ...
  if (Kh.isVoid(e5, a2)) {
    ...
    if (d2)
      return Kh.range(e5, d2);
  }
  var f2 = this.getWindow(e5).document;
  if (f2.caretRangeFromPoint)
    i2 = f2.caretRangeFromPoint(n2, r2);
  else {
  ...
  if (l2) {
    ...
    if (p2 && g2.document.createRange) {
      ...
      f2 && ((p2 = f2.querySelector("[data-slate-leaf]")) ? (c2 = p2.closest('[data-slate-node="text"]'), d2 = (h2 = p2).textContent.length, h2.querySelectorAll("[data-slate-zero-width]").forEach(function(e6) {
...
function Ry(e5, t2) {
  return $h.isElement(e5) ? wy(e5, t2) : function(e6, t3) {
    var n2 = e6.text;
    if (null == n2)
      throw new Error("Current node is not slate Text ".concat(JSON.stringify(e6)));
    var r2 = n2;
    r2 = function(e7) {
...
var Ob = function(e5) {
  ...
  return t2.insertText = function(e6) {
    ...
    if (e5.selection && fg.isCollapsed(e5.selection)) {
      ...
      if (r3) {
        var o3 = Qg(r3, 2)[1], a2 = Kh.range(e5, o3, e5.selection.anchor), s2 = function(e6, t3) {
          ...
          if (My(e6, Kh.range(e6, r4[o4]), n4))
            return Kh.range(e6, r4[o4], n4);
          if (r4.length < 2)
            return Kh.range(e6, r4[r4.length - 1], n4);
          for (; a3 !== r4.length && a3 !== o4; )
            My(e6, Kh.range(e6, r4[a3]), n4) ? i3 = a3 : o4 = a3, a3 = Math.floor((o4 + i3) / 2);
    ...
    if (null == r3)
      return true;
    if (!$h.isElement(r3) || "paragraph" !== r3.type)
      return false;
    ...
    if (void 0 === e6 && (e6 = ""), void 0 === n3 && (n3 = false), e6) {
      ...
      if (o3 = o3.filter(function(e7) {
        ...
        if (null != i3) {
          var a2 = null;
          if (_y.isSelectedEmptyParagraph(t2) && !n3)
            a2 = [i3.focus.path[0]];
    ...
    if (jg.insertFragment(t2, i3), r3 || (t2.deselect(), t2.blur()), n3 && (t2.deselect(), t2.disable()), t2.isFocused())
      try {
  ...
  var e5 = function() {
    ...
    return qy = function(t3) {
      if ("function" != typeof t3)
        return false;
      if (!hasOwnProperty.call(t3, "length"))
        return false;
      try {
        if ("number" != typeof t3.length)
          return false;
        if ("function" != typeof t3.call)
          return false;
        if ("function" != typeof t3.apply)
          return false;
      } catch (e7) {
        return false;
      }
...
var zb = (xb || (xb = 1, function(e5, t2) {
  var n2, r2, o2, i2, a2, s2, u2, l2 = Hb(), c2 = (Ab || (Ab = 1, Sb = function(e6) {
    if ("function" != typeof e6)
      throw new TypeError(e6 + " is not a function");
    return e6;
  ...
  n2 = function(e6, t3) {
    ...
    var n3, r3, o3, i3;
    if (c2(t3), !v2.call(this, "__ee__"))
      return this;
    if (!(n3 = this.__ee__)[e6])
      return this;
    if ("object" == typeof (r3 = n3[e6]))
      for (i3 = 0; o3 = r3[i3]; ++i3)
        o3 !== t3 && o3.__eeOnceListener__ !== t3 || (2 === r3.length ? n3[e6] = r3[i3 ? 0 : 1] : r3.splice(i3, 1));
    else
      r3 !== t3 && r3.__eeOnceListener__ !== t3 || delete n3[e6];
    return this;
  }, i2 = function(e6) {
    var t3, n3, r3, o3, i3;
    if (v2.call(this, "__ee__") && (o3 = this.__ee__[e6]))
      if ("object" == typeof o3) {
...
var Kb = function(e5) {
  ...
  return t2.insertText = function(e6) {
    ...
    if (t2.getConfig().maxLength) {
      if (e6.length > 0) {
        var n3 = e6[0];
        if (_y.getLeftLengthOfMaxLength(t2) < eg.string(n3).length)
          return;
        o2([n3]);
        for (var r3 = 1; r3 < e6.length; r3 += 1)
          t2.insertNode(e6[r3]);
      }
    } else
      o2(e6);
...
function Zb(e5, t2, n2) {
    ...
    var f2 = function(e6) {
      ...
      for (var n3 = 0; t3.length > 0; ) {
        ...
        if (r3.nodeType === Um.ELEMENT_NODE) {
          ...
          if (Hm.includes(i3) || "iframe" === i3 || "video" === i3)
            return r3;
          var a3 = r3.children || [], s3 = a3.length;
          if (s3)
            for (var u3 = s3 - 1; u3 >= 0; u3 -= 1)
              t3.push(a3[u3]);
        }
      }
      return null;
  ...
  if ("bar" === n2)
    return b2.left = "".concat(C2, "px"), E2 > 40 ? b2.bottom = "".concat(y2 - E2 + 5, "px") : b2.top = "".concat(E2 + c2 + 5, "px"), b2;
  if ("modal" === n2) {
    if (o2 ? i2 ? C2 > (m2 - d2) / 2 ? b2.right = "".concat(m2 - C2 + 5, "px") : b2.left = "".concat(C2 + d2 + 5, "px") : b2.left = "20px" : b2.left = "".concat(C2, "px"), o2)
      (D2 = E2) < 0 && (D2 = 0), b2.top = "".concat(D2, "px");
    else if (E2 > (y2 - c2) / 2)
      b2.bottom = "".concat(y2 - E2 + 5, "px");
    else {
      var D2;
  ...
  return Qb = function(e6, t3, n3) {
    ...
    function D2() {
      ...
      if (r3 = arguments, o3 = this, u3 = e7, n4) {
        ...
        if (v2)
          return s3 = setTimeout(E2, t3), y2(u3);
      }
...
var dE = (e5, t2, n2) => {
  ...
  if (void 0 !== r2 || 1 === t2.length)
    return void (r2[o2] = n2);
  let i2 = t2[t2.length - 1], a2 = t2.slice(0, t2.length - 1), s2 = cE(e5, a2, Object);
  for (; void 0 === s2.obj && a2.length; )
    i2 = `${a2[a2.length - 1]}.${i2}`, a2 = a2.slice(0, a2.length - 1), s2 = cE(e5, a2, Object), s2 && s2.obj && void 0 !== s2.obj[`${s2.k}.${i2}`] && (s2.obj = void 0);
  s2.obj[`${s2.k}.${i2}`] = n2;
};
var fE = (e5, t2) => {
...
var pE = (e5, t2, n2) => {
  for (const r2 in t2)
    "__proto__" !== r2 && "constructor" !== r2 && (r2 in e5 ? oE(e5[r2]) || e5[r2] instanceof String || oE(t2[r2]) || t2[r2] instanceof String ? n2 && (e5[r2] = t2[r2]) : pE(e5[r2], t2[r2], n2) : e5[r2] = t2[r2]);
  return e5;
};
...
var bE = function(e5, t2) {
  ...
  for (let e6 = 0; e6 < r2.length; ) {
    if (!o2 || "object" != typeof o2)
      return;
    let t3, i2 = "";
    for (let a2 = e6; a2 < r2.length; ++a2)
      if (a2 !== e6 && (i2 += n2), i2 += r2[a2], t3 = o2[i2], void 0 !== t3) {
        if (["string", "number", "boolean"].indexOf(typeof t3) > -1 && a2 < r2.length - 1)
          continue;
        e6 += a2 - e6 + 1;
        break;
      }
...
var AE = class extends SE {
  ...
  addResources(e5, t2, n2) {
    ...
    for (const r3 in n2)
      (oE(n2[r3]) || Array.isArray(n2[r3])) && this.addResource(e5, t2, r3, n2[r3], { silent: true });
...
var NE = class _NE extends SE {
  ...
  translate(e5, t2, n2) {
    if ("object" != typeof t2 && this.options.overloadTranslationOptionHandler && (t2 = this.options.overloadTranslationOptionHandler(arguments)), "object" == typeof t2 && (t2 = { ...t2 }), t2 || (t2 = {}), null == e5)
      return "";
    ...
    if (!(v2 && d2 && m2 && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(h2) < 0) || oE(g2) && Array.isArray(d2))
      if (v2 && oE(g2) && Array.isArray(d2))
        d2 = d2.join(g2), d2 && (d2 = this.extendTranslation(d2, e5, t2, n2));
      else {
        ...
        if (a3 || r3 || y2) {
          ...
          if ("fallback" === this.options.saveMissingTo && n3 && n3[0])
            for (let t3 = 0; t3 < n3.length; t3++)
              e6.push(n3[t3]);
          else
            "all" === this.options.saveMissingTo ? e6 = this.languageUtils.toResolveHierarchy(t2.lng || this.language) : e6.push(t2.lng || this.language);
          const r4 = (e7, n4, r5) => {
      ...
      if (o2) {
        ...
        for (const e7 in d2)
          if (Object.prototype.hasOwnProperty.call(d2, e7)) {
            const i3 = `${r3}${o2}${e7}`;
  ...
  extendTranslation(e5, t2, n2, r2, o2) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse)
      e5 = this.i18nFormat.parse(e5, { ...this.options.interpolation.defaultVariables, ...n2 }, n2.lng || this.language || r2.usedLng, r2.usedNS, r2.usedKey, { resolved: r2 });
      ...
      !n2.lng && "v1" !== this.options.compatibilityAPI && r2 && r2.res && (n2.lng = this.language || r2.usedLng), false !== n2.nest && (e5 = this.interpolator.nest(e5, function() {
        for (var e6 = arguments.length, r3 = new Array(e6), a4 = 0; a4 < e6; a4++)
          r3[a4] = arguments[a4];
      ...
      l2.forEach((e7) => {
        this.isValidLookup(t2) || (i2 = e7, !OE[`${p2[0]}-${e7}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(i2) && (OE[`${p2[0]}-${e7}`] = true, this.logger.warn(`key "${n2}" for languages "${p2.join(", ")}" won't get resolved as namespace "${i2}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), p2.forEach((n3) => {
          ...
          if (this.i18nFormat && this.i18nFormat.addLookupKeys)
            this.i18nFormat.addLookupKeys(i3, u2, n3, e7, a2);
          else {
            let e8;
          ...
          let s3;
          for (; s3 = i3.pop(); )
            this.isValidLookup(t2) || (r2 = s3, t2 = this.getResource(n3, e7, s3, a2));
        }));
      });
  ...
  static hasDefaultValue(e5) {
    ...
    for (const n2 in e5)
      if (Object.prototype.hasOwnProperty.call(e5, n2) && t2 === n2.substring(0, 12) && void 0 !== e5[n2])
        return true;
    return false;
  }
};
...
var TE = class {
    ...
    if (oE(e5) && e5.indexOf("-") > -1) {
      if ("undefined" != typeof Intl && void 0 !== Intl.getCanonicalLocales)
        try {
          ...
          if (t3 && this.options.lowerCaseLng && (t3 = t3.toLowerCase()), t3)
            return t3;
        } catch (e6) {
        }
  ...
  getFallbackCodes(e5, t2) {
    if (!e5)
      return [];
    if ("function" == typeof e5 && (e5 = e5(t2)), oE(e5) && (e5 = [e5]), Array.isArray(e5))
      return e5;
    if (!t2)
      return e5.default || [];
    let n2 = e5[t2];
...
var RE = class {
  ...
  getRule(e5) {
    ...
    if (this.shouldUseIntlApi()) {
      ...
      if (o2 in this.pluralRulesCache)
        return this.pluralRulesCache[o2];
      let i2;
      try {
...
var jE = class {
  ...
  interpolate(e5, t2, n2, r2) {
    ...
    return d2.forEach((t3) => {
      for (a2 = 0; o2 = t3.regex.exec(e5); ) {
        const n3 = o2[1].trim();
        if (i2 = u2(n3), void 0 === i2)
          if ("function" == typeof l2) {
            const t4 = l2(e5, o2, r2);
            i2 = oE(t4) ? t4 : "";
          } else if (r2 && Object.prototype.hasOwnProperty.call(r2, n3))
            i2 = "";
          else {
            if (c2) {
              i2 = o2[0];
          ...
          oE(i2) || this.useRawValueToEscape || (i2 = aE(i2));
        const s3 = t3.safeValue(i2);
        if (e5 = e5.replace(o2[0], s3), c2 ? (t3.regex.lastIndex += i2.length, t3.regex.lastIndex -= o2[0].length) : t3.regex.lastIndex = 0, a2++, a2 >= this.maxReplaces)
          break;
      }
    }), e5;
  }
  nest(e5, t2) {
    ...
    for (; n2 = this.nestingRegexp.exec(e5); ) {
      ...
      if (r2 = t2(a2.call(this, n2[1].trim(), o2), o2), r2 && n2[0] === e5 && !oE(r2))
        return r2;
...
var $E = class extends SE {
  ...
  read(e5, t2, n2) {
    ...
    if (this.readingCalls >= this.maxParallelReads)
      return void this.waitingReads.push({ lng: e5, ns: t2, fcName: n2, tried: r2, wait: o2, callback: i2 });
    this.readingCalls++;
    const a2 = (a3, s3) => {
  ...
  prepareLoading(e5, t2) {
    ...
    if (!this.backend)
      return this.logger.warn("No backend was added via i18next.use. Will not load resources."), r2 && r2();
    oE(e5) && (e5 = this.languageUtils.toResolveHierarchy(e5)), oE(t2) && (t2 = [t2]);
    const o2 = this.queueLoad(e5, t2, n2, r2);
    if (!o2.toLoad.length)
      return o2.pending.length || r2(), null;
  ...
  saveMissing(e5, t2, n2, r2, o2) {
    ...
    if (this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(t2))
      this.logger.warn(`did not save key "${n2}" as the namespace "${t2}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!");
    else if (null != n2 && "" !== n2) {
...
var GE = class _GE extends SE {
  ...
  init() {
    ...
    const i2 = iE(), a2 = () => {
      ...
      if (this.languages && "v1" !== this.options.compatibilityAPI && !this.isInitialized)
        return e6(null, this.t.bind(this));
  ...
  loadResources(e5) {
    ...
    if ("function" == typeof e5 && (t2 = e5), !this.options.resources || this.options.partialBundledLanguages) {
      if (n2 && "cimode" === n2.toLowerCase() && (!this.options.preload || 0 === this.options.preload.length))
        return t2();
      const e6 = [], r2 = (t3) => {
        if (!t3)
          return;
  ...
  setResolvedLanguage(e5) {
    if (e5 && this.languages && !(["cimode", "dev"].indexOf(e5) > -1))
      for (let e6 = 0; e6 < this.languages.length; e6++) {
  ...
  getFixedT(e5, t2, n2) {
    ...
    const o2 = function(e6, t3) {
      let i2;
      if ("object" != typeof t3) {
        for (var a2 = arguments.length, s2 = new Array(a2 > 2 ? a2 - 2 : 0), u2 = 2; u2 < a2; u2++)
          s2[u2 - 2] = arguments[u2];
...
function XE(e5) {
  qE.changeLanguage(e5);
}
function ZE(e5) {
  return qE.getResourceBundle(e5, KE);
}
function JE(e5) {
...
function rC(e5, t2, n2, r2, o2) {
  if (void 0 === r2 && (r2 = ""), void 0 === o2 && (o2 = false), t2) {
    ...
    if (o2)
      r2 && (e5.attr("data-tooltip", r2), e5.addClass("w-e-menu-tooltip-v5"), e5.addClass("tooltip-right"));
    else {
      var a2 = r2 ? "".concat(n2, "\n").concat(r2) : n2;
...
var oC = function() {
  function e5(e6, t2, n2) {
    ...
    if ("button" !== o2)
      throw new Error("Invalid tag '".concat(o2, "', expected 'button'"));
...
function dC(e5, t2, n2) {
  var r2 = am('<label class="babel-container"></label>');
  r2.append("<span>".concat(e5, "</span>"));
  var o2 = am('<textarea type="text" id="'.concat(t2, '" placeholder="').concat(n2 || "", '"></textarea>'));
  return r2.append(o2), [r2[0], o2[0]];
}
function fC(e5, t2) {
...
var pC = function(e5) {
  ...
  return Kg(t2, e5), t2.prototype.onButtonClick = function() {
    ...
    if (null != r2.getModalContentElem) {
      ...
      if (e6.renderContent(s2), a2)
        e6.setStyle({ left: "0", right: "0" });
      else {
...
var gC = function() {
  function e5(e6, t2, n2) {
    ...
    if ("select" !== o2)
      throw new Error("Invalid tag '".concat(o2, "', expected 'select'"));
    var d2 = this.$button;
...
function bC(e5, t2, n2) {
  ...
  if ("select" === o2 && (r2 = new gC(e5, t2, n2)), null == r2)
    throw new Error("Invalid tag in menu ".concat(JSON.stringify(t2)));
...
var wC = function() {
  ...
  return e5.prototype.getMenus = function() {
    ...
    if (null == r2) {
      var o2 = bv[e6];
      if (null == o2)
        throw new Error("Not found menu item factory by key '".concat(e6, "'"));
      if ("function" != typeof o2)
        throw new Error("Menu item factory (key='".concat(e6, "') is not a function"));
      r2 = o2(), n2[e6] = r2;
    }
  ...
  function p2(t3, n3, r3) {
    ...
    function w2() {
      ...
      if (o3 = arguments, i3 = this, l3 = e6, t4) {
        ...
        if (m2)
          return u3 = setTimeout(C2, n3), b2(l3);
      }
...
var kC = (e5, t2) => {
  if (e5.clientHeight < e5.scrollHeight || e5.clientWidth < e5.scrollWidth) {
    ...
    return TC(n2.overflowY, t2) || TC(n2.overflowX, t2) || ((e6) => {
      const t3 = ((e7) => {
        if (!e7.ownerDocument || !e7.ownerDocument.defaultView)
          return null;
        try {
...
var PC = (e5, t2) => {
  ...
  for (let e6 = 0; e6 < p2.length; e6++) {
    ...
    if ("if-needed" === a2 && C2 >= 0 && S2 >= 0 && w2 <= v2 && D2 <= g2 && (t3 === f2 && !kC(t3) || C2 >= o3 && w2 <= l3 && S2 >= c3 && D2 <= i3))
      return k2;
    ...
    if (f2 === t3)
      N3 = "start" === s2 ? B2 : "end" === s2 ? B2 - v2 : "nearest" === s2 ? FC(y2, y2 + v2, v2, A3, O3, y2 + B2, y2 + B2 + b2, b2) : B2 - v2 / 2, F2 = "start" === u2 ? T2 : "center" === u2 ? T2 - g2 / 2 : "end" === u2 ? T2 - g2 : FC(m2, m2 + g2, g2, h3, x3, m2 + T2, m2 + T2 + E2, E2), N3 = Math.max(0, N3 + y2), F2 = Math.max(0, F2 + m2);
    else {
...
function _C(e5, t2) {
  ...
  if (((e6) => "object" == typeof e6 && "function" == typeof e6.behavior)(t2))
    return t2.behavior(PC(e5, t2));
  ...
  if (i2 && (!e5.isComposing || n2) && t2.isFocused()) {
    ...
    if (r2 || a2) {
      ...
      if (!r2 || _y.hasRange(t2, r2)) {
        ...
        t2.selection = _y.toSlateRange(t2, i2, { exactMatch: false, suppressThrow: false });
    }
  }
}
...
var zC = function() {
  ...
  function a2(e6, o3) {
    ...
    try {
      for (var g2, v2 = s3[Symbol.iterator](); !(f2 = (g2 = v2.next()).done); f2 = true) {
        ...
        if (m2.length > 1 && !E2 && !n2[m2] && !r2[b2])
          throw new TypeError('Unknown modifier: "' + m2 + '"');
  ...
  function s2(e6, t3) {
    for (var n3 in e6) {
      ...
      if (null != r3 && ((null != (o3 = "key" === n3 && null != t3.key ? t3.key.toLowerCase() : "which" === n3 ? 91 === r3 && 93 === t3.which ? 91 : t3.which : t3[n3]) || false !== r3) && o3 !== r3))
        return false;
    }
    return true;
  }
...
var KC = { beforeinput: function(e5, t2, n2) {
  ...
  if (Py && !o2 && xC(n2, r2.target)) {
    ...
    if ("insertCompositionText" !== a2 && "deleteCompositionText" !== a2) {
      ...
      switch (a2) {
        ...
        case "insertText":
          if ("insertFromPaste" === a2 && !qv.get(n2))
            break;
    ...
    if (i2 !== a2.activeElement) {
      ...
      if (!(s2 === _y.toDOMNode(n2, n2) || Ym(s2) && s2.hasAttribute("data-slate-spacer"))) {
        if (null != s2 && qm(s2) && _y.hasDOMNode(n2, s2)) {
          ...
          if ($h.isElement(u2) && !n2.isVoid(u2))
            return;
        }
        if (Ty) {
      ...
      if (l2) {
          ...
          f2 && function(e6, t3) {
            if (fg.isCollapsed(t3)) {
              ...
              if ([2, 3].includes(n3.path.length) && [2, 3].includes(r3.path.length) && (0 === n3.offset || 0 === r3.offset)) {
                ...
                if (Cg.isText(s3[0]) && Cg.isText(o3[0]))
                  return true;
              }
            }
        ...
        Ty || setTimeout(function() {
          ...
          if (null != e6) {
            var t3 = MC.get(n2);
            if (null != t3)
              _y.toDOMRange(n2, e6).startContainer !== t3 && (t3.textContent = LC.get(n2) || "");
          }
        });
      }
    }
  ...
  if (!n2.getConfig().readOnly && !t2.isComposing && xC(n2, r2.target)) {
    if (function(e6, t3) {
      ...
      return qC(r2), void n2.handleTab();
    if (GC.isRedo(r2))
      return qC(r2), void ("function" == typeof n2.redo && n2.redo());
    if (GC.isUndo(r2))
      return qC(r2), void ("function" == typeof n2.undo && n2.undo());
    if (GC.isMoveLineBackward(r2))
      return qC(r2), void jg.move(n2, { unit: "line", reverse: true });
    if (GC.isMoveLineForward(r2))
      return qC(r2), void jg.move(n2, { unit: "line" });
    if (GC.isExtendLineBackward(r2))
      return qC(r2), void jg.move(n2, { unit: "line", edge: "focus", reverse: true });
    if (GC.isExtendLineForward(r2))
      return qC(r2), void jg.move(n2, { unit: "line", edge: "focus" });
    if (GC.isMoveBackward(r2))
      return qC(r2), void (o2 && fg.isCollapsed(o2) ? jg.move(n2, { reverse: true }) : jg.collapse(n2, { edge: "start" }));
    if (GC.isMoveForward(r2))
      return qC(r2), void (o2 && fg.isCollapsed(o2) ? jg.move(n2) : jg.collapse(n2, { edge: "end" }));
    if (GC.isMoveWordBackward(r2))
      return qC(r2), o2 && fg.isExpanded(o2) && jg.collapse(n2, { edge: "focus" }), void jg.move(n2, { unit: "word", reverse: true });
    if (GC.isMoveWordForward(r2))
      return qC(r2), o2 && fg.isExpanded(o2) && jg.collapse(n2, { edge: "focus" }), void jg.move(n2, { unit: "word" });
    if (GC.isSelectAll(r2))
      return qC(r2), void n2.selectAll();
    if (Py) {
      if ((Iy || Ty) && o2 && (GC.isDeleteBackward(r2) || GC.isDeleteForward(r2)) && fg.isCollapsed(o2)) {
        var i2 = eg.parent(n2, o2.anchor.path);
        if ($h.isElement(i2) && Kh.isVoid(n2, i2) && Kh.isInline(n2, i2))
          return r2.preventDefault(), void jg.delete(n2, { unit: "block" });
      }
    } else {
      if (GC.isBold(r2) || GC.isItalic(r2) || GC.isTransposeCharacter(r2))
        return void qC(r2);
      if (GC.isSplitBlock(r2))
        return qC(r2), void Kh.insertBreak(n2);
      if (GC.isDeleteBackward(r2))
        return qC(r2), void (o2 && fg.isExpanded(o2) ? Kh.deleteFragment(n2, { direction: "backward" }) : Kh.deleteBackward(n2));
      if (GC.isDeleteForward(r2))
        return qC(r2), void (o2 && fg.isExpanded(o2) ? Kh.deleteFragment(n2, { direction: "forward" }) : Kh.deleteForward(n2));
      if (GC.isDeleteLineBackward(r2))
        return qC(r2), void (o2 && fg.isExpanded(o2) ? Kh.deleteFragment(n2, { direction: "backward" }) : Kh.deleteBackward(n2, { unit: "line" }));
      if (GC.isDeleteLineForward(r2))
        return qC(r2), void (o2 && fg.isExpanded(o2) ? Kh.deleteFragment(n2, { direction: "forward" }) : Kh.deleteForward(n2, { unit: "line" }));
      if (GC.isDeleteWordBackward(r2))
        return qC(r2), void (o2 && fg.isExpanded(o2) ? Kh.deleteFragment(n2, { direction: "backward" }) : Kh.deleteBackward(n2, { unit: "word" }));
      if (GC.isDeleteWordForward(r2))
        return qC(r2), void (o2 && fg.isExpanded(o2) ? Kh.deleteFragment(n2, { direction: "forward" }) : Kh.deleteForward(n2, { unit: "word" }));
    }
  }
  ...
  if (!n2.getConfig().readOnly && (r2.preventDefault(), xC(n2, r2.target))) {
    ...
    if (null != i2 && (n2.setFragmentData(i2), o2))
      if (fg.isExpanded(o2))
        Kh.deleteFragment(n2);
      else {
  ...
  if (NC(n2, r2.target) && !n2.getConfig().readOnly) {
    ...
    if (null != s2)
      _y.getSelectedNodeByType(n2, "table") || (t2.isDraggingInternally = true, n2.setFragmentData(s2));
  }
...
var sD = ["create", "update", "remove", "destroy", "pre", "post"];
function uD(e5, t2, n2) {
  ...
  function u2(e6, t3) {
    ...
    if ("!" === c3)
      nD(e6.text) && (e6.text = ""), e6.elm = o2.createComment(e6.text);
    else if ("" === c3)
      e6.elm = o2.createTextNode(e6.text);
    else if (void 0 !== c3) {
      ...
      for (f3 < p2 && g2.setAttribute("id", c3.slice(f3 + 1, p2)), d3 > 0 && g2.setAttribute("class", c3.slice(p2 + 1).replace(/\./g, " ")), a3 = 0; a3 < r2.create.length; ++a3)
        r2.create[a3](oD, e6);
      if (!tD(e6.text) || eD(l3) && 0 !== l3.length || o2.appendChild(g2, o2.createTextNode(e6.text)), eD(l3))
  ...
  function c2(e6) {
    ...
    if (void 0 !== o3) {
      ...
      for (let t4 = 0; t4 < r2.destroy.length; ++t4)
        r2.destroy[t4](e6);
      if (void 0 !== e6.children)
        for (let t4 = 0; t4 < e6.children.length; ++t4) {
    ...
    for (var a3, u3; n3 <= i3; ++n3) {
      ...
      if (null != f3)
        if (rD(f3.sel)) {
          ...
          for (let e8 = 0; e8 < r2.remove.length; ++e8)
            r2.remove[e8](f3, l3);
          const e7 = null === (u3 = null === (a3 = null == f3 ? void 0 : f3.data) || void 0 === a3 ? void 0 : a3.hook) || void 0 === u3 ? void 0 : u3.remove;
          rD(e7) ? e7(f3, l3) : l3();
        } else
          f3.children ? (c2(f3), d2(e6, f3.children, 0, f3.children.length - 1)) : o2.removeChild(e6, f3.elm);
    }
  }
  function f2(e6, t3, n3) {
    ...
    if (void 0 !== t3.data || rD(t3.text) && t3.text !== e6.text) {
      ...
      for (let n4 = 0; n4 < r2.update.length; ++n4)
        r2.update[n4](e6, t3);
  ...
  return function(e6, t3) {
    let n3, s3, l3;
    const c3 = [];
    for (n3 = 0; n3 < r2.pre.length; ++n3)
      r2.pre[n3]();
    for (!function(e7, t4) {
      return e7.isElement(t4);
    }(o2, e6) ? function(e7, t4) {
      return e7.isDocumentFragment(t4);
    }(o2, e6) && (e6 = a2(e6)) : e6 = i2(e6), iD(e6, t3) ? f2(e6, t3, c3) : (s3 = e6.elm, l3 = o2.parentNode(s3), u2(t3, c3), null !== l3 && (o2.insertBefore(l3, t3.elm, o2.nextSibling(s3)), d2(l3, [e6], 0, 0))), n3 = 0; n3 < c3.length; ++n3)
      c3[n3].data.hook.insert(c3[n3]);
    for (n3 = 0; n3 < r2.post.length; ++n3)
      r2.post[n3]();
    return t3;
  };
}
function lD(e5, t2, n2) {
  if (e5.ns = "http://www.w3.org/2000/svg", "foreignObject" !== n2 && void 0 !== t2)
...
function cD(e5, t2, n2) {
  let r2, o2, i2, a2 = {};
  if (void 0 !== n2 ? (null !== t2 && (a2 = t2), eD(n2) ? r2 = n2 : tD(n2) ? o2 = n2.toString() : n2 && n2.sel && (r2 = [n2])) : null != t2 && (eD(t2) ? r2 = t2 : tD(t2) ? o2 = t2.toString() : t2 && t2.sel ? r2 = [t2] : a2 = t2), void 0 !== r2)
    for (i2 = 0; i2 < r2.length; ++i2)
      tD(r2[i2]) && (r2[i2] = QC(void 0, void 0, void 0, r2[i2], void 0));
...
function dD(e5, t2) {
  ...
  if ((o2 || i2) && o2 !== i2) {
    ...
    for (n2 in o2)
      n2 in i2 || r2.removeAttribute(n2);
  }
}
...
function pD(e5, t2) {
  ...
  if ((i2 || a2) && i2 !== a2) {
    ...
    for (r2 in a2)
      n2 = a2[r2], n2 !== i2[r2] && o2.classList[n2 ? "add" : "remove"](r2);
  }
}
var hD = { create: pD, update: pD };
var gD = /[A-Z]/g;
function vD(e5, t2) {
  const n2 = t2.elm;
  ...
  const a2 = n2.dataset;
  for (r2 in o2)
    r2 in i2 || (a2 ? r2 in a2 && delete a2[r2] : n2.removeAttribute("data-" + r2.replace(gD, "-$&").toLowerCase()));
  for (r2 in i2)
    o2[r2] !== i2[r2] && (a2 ? a2[r2] = i2[r2] : n2.setAttribute("data-" + r2.replace(gD, "-$&").toLowerCase(), i2[r2]));
}
var mD = { create: vD, update: vD };
...
function ED(e5, t2) {
  ...
  if (n2 !== i2) {
    if (n2 && r2)
      if (i2)
        for (s2 in n2)
          i2[s2] || o2.removeEventListener(s2, r2, false);
      else
        for (s2 in n2)
          o2.removeEventListener(s2, r2, false);
    if (i2) {
      ...
      if (r3.vnode = t2, n2)
        for (s2 in i2)
          n2[s2] || a2.addEventListener(s2, r3, false);
      else
        for (s2 in i2)
          a2.addEventListener(s2, r3, false);
    }
  }
}
var CD = { create: ED, update: ED, destroy: ED };
function DD(e5, t2) {
  let n2, r2, o2;
  const i2 = t2.elm;
  let a2 = e5.data.props, s2 = t2.data.props;
  if ((a2 || s2) && a2 !== s2)
    for (n2 in a2 = a2 || {}, s2 = s2 || {}, s2)
      r2 = s2[n2], o2 = a2[n2], o2 === r2 || "value" === n2 && i2[n2] === r2 || (i2[n2] = r2);
}
var wD = { create: DD, update: DD };
var SD = "function" == typeof (null === window || void 0 === window ? void 0 : window.requestAnimationFrame) ? window.requestAnimationFrame.bind(window) : setTimeout;
var AD = false;
...
function OD(e5, t2) {
  ...
  for (r2 in i2)
    r2 in a2 || ("-" === r2[0] && "-" === r2[1] ? o2.style.removeProperty(r2) : o2.style[r2] = "");
  for (r2 in a2)
    if (n2 = a2[r2], "delayed" === r2 && a2.delayed)
      for (const e6 in a2.delayed)
        n2 = a2.delayed[e6], s2 && n2 === i2.delayed[e6] || xD(o2.style, e6, n2);
    else
      "remove" !== r2 && n2 !== i2[r2] && ("-" === r2[0] && "-" === r2[1] ? o2.style.setProperty(r2, n2) : o2.style[r2] = n2);
}
var ND = { pre: function() {
  AD = false;
...
function BD(e5, t2) {
  for (const n2 of e5)
    null != n2 && false !== n2 && "" !== n2 && (Array.isArray(n2) ? BD(n2, t2) : "string" == typeof n2 || "number" == typeof n2 || "boolean" == typeof n2 ? t2.push(QC(void 0, void 0, void 0, String(n2), void 0)) : t2.push(n2));
  return t2;
}
...
function jD(e5, t2, n2) {
  if (null == e5.text)
    throw new Error("Current node is not slate Text ".concat(JSON.stringify(e5)));
  ...
  var i2, a2 = _y.findPath(n2, e5), s2 = o2([e5, a2]), u2 = Cg.decorations(e5, s2), l2 = u2.map(function(r3, o3) {
    var i3 = function(e6, t3, n3, r4, o4) {
      ...
      if (Kh.isEditor(r4))
        throw new Error("Text node ".concat(JSON.stringify(n3), " parent is Editor"));
...
var zD = function() {
  ...
  var te2, ne2, re2 = (te2 = function(e6, t3, n3) {
    ...
    return function(e7, t3, n3) {
      for (var r3 = -1, o3 = e7 ? e7.length : 0; ++r3 < o3; )
        n3 = t3(n3, e7[r3], r3, e7);
      return n3;
    }(function(e7, t3) {
  ...
  l2.children = c2.map(function(e6, n3) {
    if (Pv.has(e6)) {
      ...
      if (r3) {
        ...
        if (a3)
          return i3 !== n3 && (Rv.set(e6, n3), Pv.set(e6, [n3, a3])), a3;
      }
    }
...
var qD = function() {
  function e5(e6) {
    ...
    this.id = GD++, this.$textArea = null, this.$progressBar = am('<div class="w-e-progress-bar"></div>'), this.$maxLengthInfo = am('<div class="w-e-max-length-info"></div>'), this.isComposing = false, this.isUpdatingSelection = false, this.isDraggingInternally = false, this.latestElement = null, this.showPlaceholder = false, this.$placeholder = null, this.latestEditorSelection = null, this.onDOMSelectionChange = AC(function() {
      ...
      !function(e8, t3) {
        ...
        if (!(t3.getConfig().readOnly || n3 || r3 || o3)) {
          ...
          if (a2 !== s2)
            return Vv.delete(t3), void jg.deselect(t3);
          if (e8.latestElement = a2, Vv.set(t3, true), !u2)
            return jg.deselect(t3);
    ...
    var n2 = am(e6);
    if (0 === n2.length)
      throw new Error("Cannot find textarea DOM by selector '".concat(e6, "'"));
    this.$box = n2;
...
function XD(e5) {
  var t2 = e5.selector, n2 = void 0 === t2 ? "" : t2, r2 = e5.config, o2 = void 0 === r2 ? {} : r2, i2 = e5.content, a2 = e5.html, s2 = e5.plugins, u2 = void 0 === s2 ? [] : s2, l2 = function(e6) {
    ...
    var e6 = { children: [], operations: [], selection: null, marks: null, isInline: () => false, isVoid: () => false, onChange: () => {
      ...
      for (var n3 of Kh.pathRefs(e6))
        ig.transform(n3, t3);
      for (var r3 of Kh.pointRefs(e6))
        lg.transform(r3, t3);
      for (var o3 of Kh.rangeRefs(e6))
        pg.transform(o3, t3);
      ...
      if (og.operationCanTransformPath(t3))
        for (var c3 of (i3 = [], a3 = /* @__PURE__ */ new Set(), s3))
          l3(og.transform(c3, t3));
      else
        i3 = s3, a3 = u3;
      ...
      if (r3)
        if (fg.isExpanded(r3))
          jg.setNodes(e6, { [t3]: n3 }, { match: Cg.isText, split: true });
        else {
      ...
      var [n3, r3] = t3;
      if (!Cg.isText(n3))
        if ($h.isElement(n3) && 0 === n3.children.length)
          jg.insertNodes(e6, { text: "" }, { at: r3.concat(0), voids: true });
        else
          for (var o3 = !Kh.isEditor(n3) && $h.isElement(n3) && (e6.isInline(n3) || 0 === n3.children.length || Cg.isText(n3.children[0]) || e6.isInline(n3.children[0])), i3 = 0, a3 = 0; a3 < n3.children.length; a3++, i3++) {
            var s3 = eg.get(e6, r3);
            if (!Cg.isText(s3)) {
      ...
      if (n3)
        if (fg.isExpanded(n3))
          jg.unsetNodes(e6, t3, { match: Cg.isText, split: true });
        else {
  ...
  if (n2 && function(e6, t3) {
    ...
    throw new Error("Repeated create editor by selector '".concat(n2, "'"));
  var c2 = function(e6) {
    void 0 === e6 && (e6 = {});
  ...
  if (u2.forEach(function(e6) {
    ...
    l2.children.forEach(function(e6, t3) {
...
var ZD = function() {
  function e5(e6, t2) {
    ...
    var r2 = am(e6);
    if (0 === r2.length)
      throw new Error("Cannot find toolbar DOM by selector '".concat(e6, "'"));
    this.$box = r2;
    var o2 = this.$toolbar;
  ...
  return e5.prototype.getMenus = function() {
    ...
    p2.forEach(function(r3, o3) {
      ...
      if ("string" == typeof r3)
        return e6.registerSingleItem(r3, e6), void (t2 = r3);
    ...
    if (null == i2) {
      ...
      console.warn("Duplicated toolbar menu key '".concat(e6, "'\n重复注册了菜单栏 menu '").concat(e6, "'"));
...
function JD(e5, t2) {
  ...
  if (function(e6, t3) {
    ...
    throw new Error("Repeated create toolbar by selector '".concat(n2, "'"));
...
function sw() {
  ...
  return nw = { nanoid: (e5 = 21) => {
    let t2 = "", n2 = 0 | e5;
    for (; n2--; )
      t2 += "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict"[64 * Math.random() | 0];
    return t2;
  }, customAlphabet: (e5, t2 = 21) => (n2 = t2) => {
    let r2 = "", o2 = 0 | n2;
    for (; o2--; )
      r2 += e5[Math.random() * e5.length | 0];
    return r2;
  } }, nw;
}
var uw;
...
function Hw() {
  return lw ? uw : (lw = 1, uw = function(e5) {
    if ("number" != typeof e5 || isNaN(e5))
      throw new TypeError("Expected a number, got " + typeof e5);
...
function zw() {
  ...
  return dw = 1, e5.prototype.match = function(e6) {
    ...
    if ("string" == typeof e6 || e6 instanceof String)
      if (this.hasWild || this.text == e6) {
        for (n2 = (e6 || "").split(this.separator), t2 = 0; r2 && t2 < i2; t2++)
          "*" !== o2[t2] && (r2 = t2 < n2.length && o2[t2] === n2[t2]);
        r2 = r2 && n2;
      } else
        r2 = false;
    else if ("function" == typeof e6.splice)
      for (r2 = [], t2 = e6.length; t2--; )
        this.match(e6[t2]) && (r2[r2.length] = e6[t2]);
    else if ("object" == typeof e6)
      for (var a2 in r2 = {}, e6)
        this.match(a2) && (r2[a2] = e6[a2]);
    return r2;
  ...
  return jw.Restricter = class {
    constructor(e6, t3) {
      this.i18n = t3, this.getOpts = () => {
        const t4 = e6();
        if (null != t4.restrictions.allowedFileTypes && !Array.isArray(t4.restrictions.allowedFileTypes))
    ...
    validate(r2, o2) {
      ...
      if (u2) {
        ...
        if (e6.length + 1 > u2)
          throw new n2(`${this.i18n("youCanOnlyUploadX", { smart_count: u2 })}`);
      }
      if (l2) {
      ...
      if (s2 && null != r2.size) {
        ...
        if (t3 > s2)
          throw new n2(this.i18n("exceedsSize", { size: e5(s2), file: r2.name }));
      }
      if (i2 && null != r2.size && r2.size > i2)
        throw new n2(this.i18n("exceedsSize", { size: e5(i2), file: r2.name }));
      if (a2 && null != r2.size && r2.size < a2)
        throw new n2(this.i18n("inferiorSize", { size: e5(a2) }));
    }
    validateMinNumberOfFiles(e6) {
      const { minNumberOfFiles: t3 } = this.getOpts().restrictions;
      if (Object.keys(e6).length < t3)
        throw new n2(this.i18n("youHaveToAtLeastSelectX", { smart_count: t3 }));
    }
    getMissingRequiredMetaFields(e6) {
      ...
      for (const t4 of r2)
        o2.call(e6.meta, t4) && "" !== e6.meta[t4] || i2.push(t4);
...
function Vw() {
  if (yw)
    return mw;
  function e5(e6, t3) {
    if (!Object.prototype.hasOwnProperty.call(e6, t3))
  ...
  return mw = class {
    ...
    translateArray(e6, t3) {
      if (!r2(this.locale.strings, e6))
        throw new Error(`missing string: ${e6}`);
  ...
  return Ew || (Ew = 1, bw = function() {
    ...
    return e5.emit = function(e6, n2, r2, o2, i2, a2, s2) {
      ...
      u2.length && function(e7, t3, n3) {
        ...
        for (; r3 < o3 && t3[r3]; r3++)
          t3[r3].event = e7, t3[r3].apply(t3[r3], n3);
      ...
      var n2 = [];
      if (e6 && t3)
        for (var r2 = this._fns[e6], o2 = 0, i2 = r2 ? r2.length : 0; o2 < i2; o2++)
          r2[o2] !== t3 && n2.push(r2[o2]);
...
function Gw() {
  ...
  class r2 {
    ...
    setState(e6) {
      ...
      this.state = r3, function(e7, t4) {
        if (!Object.prototype.hasOwnProperty.call(e7, t4))
          throw new TypeError("attempted to use private field on non-instance");
        return e7;
      }(this, n2)[n2](t3, r3, e6);
    }
  ...
  function o2() {
    for (var e6 = arguments.length, t3 = new Array(e6), n3 = 0; n3 < e6; n3++)
      t3[n3] = arguments[n3];
...
function Yw() {
  ...
  const u2 = Vw(), l2 = Ww(), c2 = SC(), d2 = Gw(), f2 = function() {
    ...
    if (null == e6 && "undefined" != typeof navigator && (e6 = navigator.userAgent), !e6)
      return true;
  ...
  class L2 {
    ...
    setFileState(e6, t3) {
      if (!this.getState().files[e6])
        throw new Error(`Can’t set state for ${e6} (the file could have been removed)`);
    ...
    setFileMeta(e6, t3) {
      ...
      if (!n3[e6])
        return void this.log("Was trying to set metadata for a file that has been removed: ", e6);
 ...
 type: ${n3[e7].type}`);
        ...
        if (r3.forEach((t4) => {
          e7 += `
 * ${t4.message}`;
        }), this.info({ message: this.i18n("addBulkFilesFailed", { smart_count: r3.length }), details: e7 }, "error", this.opts.infoTimeout), "function" == typeof AggregateError)
          throw new AggregateError(r3, e7);
        {
    ...
    removeFiles(e6, t3) {
      ...
      e6.forEach((e7) => {
        ...
        if (0 === t4.length)
          return void delete i3[e7];
        const { capabilities: n4 } = this.getState();
        if (t4.length !== r3[e7].fileIDs.length && !n4.individualCancellation)
    ...
    pauseResume(e6) {
      if (!this.getState().capabilities.resumableUploads || this.getFile(e6).uploadComplete)
        return;
    ...
    retryAll() {
      ...
      if (t3.forEach((t4) => {
        ...
        e6[t4] = n4;
      }), this.setState({ files: e6, error: null }), this.emit("retry-all", t3), 0 === t3.length)
    ...
    calculateProgress(e6, t3) {
      if (null == e6 || !this.getFile(e6.id))
        return void this.log(`Not setting progress for a file that has been removed: ${null == e6 ? void 0 : e6.id}`);
...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
    ...
    addResultData(e6, t3) {
      if (!i2(this, P2)[P2](e6))
        return void this.log(`Not setting result for an upload that has been removed: ${e6}`);
    ...
    upload() {
      ...
      return false === r3 ? Promise.reject(new Error("Not starting the upload because onBeforeUpload returned false")) : (r3 && "object" == typeof r3 && (t3 = r3, this.setState({ files: t3 })), Promise.resolve().then(() => i2(this, b2)[b2].validateMinNumberOfFiles(t3)).catch((e7) => {
        ...
        if (!i2(this, O2)[O2](t3))
          throw new n2.RestrictionError(this.i18n("missingRequiredMetaField"));
      }).catch((e7) => {
        throw e7;
      }).then(() => {
  ...
  function H2(e6) {
    let t3 = true;
    for (const n3 of Object.values(e6))
      i2(this, x2)[x2](n3) || (t3 = false);
    return t3;
  }
  function z2(e6) {
  ...
  function V2() {
    ...
    this.on("error", e6), this.on("upload-error", (t3, n3, r3) => {
      ...
      if (null == e7 || !this.getFile(e7.id))
        return void this.log(`Not setting progress for a file that has been removed: ${null == e7 ? void 0 : e7.id}`);
...
var lS = {};
var cS = [];
var dS = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
...
function gS(e5, t2, n2) {
  ...
  if (arguments.length > 2 && (a2.children = arguments.length > 3 ? Xw.call(arguments, 2) : n2), "function" == typeof e5 && null != e5.defaultProps)
    for (i2 in e5.defaultProps)
      void 0 === a2[i2] && (a2[i2] = e5.defaultProps[i2]);
...
function bS(e5, t2) {
  if (null == t2)
    return e5.__ ? bS(e5.__, e5.__i + 1) : null;
  for (var n2; t2 < e5.__k.length; t2++)
    if (null != (n2 = e5.__k[t2]) && null != n2.__e)
      return n2.__e;
...
function ES(e5) {
  ...
  if (null != (e5 = e5.__) && null != e5.__c) {
    for (e5.__e = e5.__c.base = null, t2 = 0; t2 < e5.__k.length; t2++)
      if (null != (n2 = e5.__k[t2]) && null != n2.__e) {
...
function DS() {
  for (var e5, t2, n2, r2, o2, i2, a2, s2 = 1; eS.length; )
    eS.length > s2 && eS.sort(rS), e5 = eS.shift(), s2 = eS.length, e5.__d && (n2 = void 0, r2 = void 0, o2 = (r2 = (t2 = e5).__v).__e, i2 = [], a2 = [], t2.__P && ((n2 = pS({}, r2)).__v = r2.__v + 1, Zw.vnode && Zw.vnode(n2), TS(t2.__P, n2, r2, t2.__n, t2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, i2, null == o2 ? bS(r2) : o2, !!(32 & r2.__u), a2), n2.__v = r2.__v, n2.__.__k[n2.__i] = n2, FS(i2, n2, a2), r2.__e = r2.__ = null, n2.__e != o2 && ES(n2)));
  DS.__r = 0;
}
function wS(e5, t2, n2, r2, o2, i2, a2, s2, u2, l2, c2) {
  var d2, f2, p2, h2, g2, v2, m2, y2 = r2 && r2.__k || cS, b2 = t2.length;
  for (u2 = SS(n2, t2, y2, u2, b2), d2 = 0; d2 < b2; d2++)
    null != (p2 = n2.__k[d2]) && (f2 = -1 == p2.__i ? lS : y2[p2.__i] || lS, p2.__i = d2, v2 = TS(e5, p2, f2, o2, i2, a2, s2, u2, l2, c2), h2 = p2.__e, p2.ref && f2.ref != p2.ref && (f2.ref && _S(f2.ref, null, p2), c2.push(p2.ref, p2.__c || h2, p2)), null == g2 && null != h2 && (g2 = h2), (m2 = !!(4 & p2.__u)) || f2.__k === p2.__k ? u2 = AS(p2, u2, e5, m2) : "function" == typeof p2.type && void 0 !== v2 ? u2 = v2 : h2 && (u2 = h2.nextSibling), p2.__u &= -7);
  return n2.__e = g2, u2;
}
function SS(e5, t2, n2, r2, o2) {
  var i2, a2, s2, u2, l2, c2 = n2.length, d2 = c2, f2 = 0;
  for (e5.__k = new Array(o2), i2 = 0; i2 < o2; i2++)
    null != (a2 = t2[i2]) && "boolean" != typeof a2 && "function" != typeof a2 ? (u2 = i2 + f2, (a2 = e5.__k[i2] = "string" == typeof a2 || "number" == typeof a2 || "bigint" == typeof a2 || a2.constructor == String ? vS(null, a2, null, null, null) : fS(a2) ? vS(mS, { children: a2 }, null, null, null) : null == a2.constructor && a2.__b > 0 ? vS(a2.type, a2.props, a2.key, a2.ref ? a2.ref : null, a2.__v) : a2).__ = e5, a2.__b = e5.__b + 1, s2 = null, -1 != (l2 = a2.__i = xS(a2, n2, u2, d2)) && (d2--, (s2 = n2[l2]) && (s2.__u |= 2)), null == s2 || null == s2.__v ? (-1 == l2 && (o2 > c2 ? f2-- : o2 < c2 && f2++), "function" != typeof a2.type && (a2.__u |= 4)) : l2 != u2 && (l2 == u2 - 1 ? f2-- : l2 == u2 + 1 ? f2++ : (l2 > u2 ? f2-- : f2++, a2.__u |= 4))) : e5.__k[i2] = null;
  if (d2)
    for (i2 = 0; i2 < c2; i2++)
      null != (s2 = n2[i2]) && !(2 & s2.__u) && (s2.__e == r2 && (r2 = bS(s2)), RS(s2, s2));
  return r2;
}
function AS(e5, t2, n2, r2) {
  var o2, i2;
  if ("function" == typeof e5.type) {
    for (o2 = e5.__k, i2 = 0; o2 && i2 < o2.length; i2++)
      o2[i2] && (o2[i2].__ = e5, t2 = AS(o2[i2], t2, n2, r2));
    return t2;
  }
...
function xS(e5, t2, n2, r2) {
  ...
  if (null === l2 && null == e5.key || c2 && s2 == l2.key && u2 == l2.type)
    return n2;
  if (r2 > (c2 ? 1 : 0)) {
    for (o2 = n2 - 1, i2 = n2 + 1; o2 >= 0 || i2 < t2.length; )
      if (null != (l2 = t2[a2 = o2 >= 0 ? o2-- : i2++]) && !(2 & l2.__u) && s2 == l2.key && u2 == l2.type)
        return a2;
  }
  return -1;
}
  ...
  e:
    if ("style" == t2)
      if ("string" == typeof n2)
        ...
        if ("string" == typeof r2 && (e5.style.cssText = r2 = ""), r2)
          for (t2 in r2)
            n2 && t2 in n2 || OS(e5.style, t2, "");
        if (n2)
          for (t2 in n2)
            r2 && n2[t2] == r2[t2] || OS(e5.style, t2, n2[t2]);
      }
    else if ("o" == t2[0] && "n" == t2[1])
      i2 = t2 != (t2 = t2.replace(oS, "$1")), a2 = t2.toLowerCase(), t2 = a2 in e5 || "onFocusOut" == t2 || "onFocusIn" == t2 ? a2.slice(2) : t2.slice(2), e5.l || (e5.l = {}), e5.l[t2 + i2] = n2, n2 ? r2 ? n2.u = r2.u : (n2.u = iS, e5.addEventListener(t2, i2 ? sS : aS, i2)) : e5.removeEventListener(t2, i2 ? sS : aS, i2);
    else {
      if ("http://www.w3.org/2000/svg" == o2)
        t2 = t2.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");
      else if ("width" != t2 && "height" != t2 && "href" != t2 && "list" != t2 && "form" != t2 && "tabIndex" != t2 && "download" != t2 && "rowSpan" != t2 && "colSpan" != t2 && "role" != t2 && "popover" != t2 && t2 in e5)
        try {
          e5[t2] = null == n2 ? "" : n2;
          break e;
        } catch (e6) {
...
function TS(e5, t2, n2, r2, o2, i2, a2, s2, u2, l2) {
  ...
  if (null != t2.constructor)
    return null;
  128 & n2.__u && (u2 = !!(32 & n2.__u), i2 = [s2 = t2.__e = n2.__e]), (c2 = Zw.__b) && c2(t2);
  e:
    if ("function" == typeof O2)
      try {
        if (m2 = t2.props, y2 = "prototype" in O2 && O2.prototype.render, b2 = (c2 = O2.contextType) && r2[c2.__c], E2 = c2 ? b2 ? b2.props.value : c2.__ : r2, n2.__c ? v2 = (d2 = t2.__c = n2.__c).__ = d2.__E : (y2 ? t2.__c = d2 = new O2(m2, E2) : (t2.__c = d2 = new yS(m2, E2), d2.constructor = O2, d2.render = LS), b2 && b2.sub(d2), d2.props = m2, d2.state || (d2.state = {}), d2.context = E2, d2.__n = r2, f2 = d2.__d = true, d2.__h = [], d2._sb = []), y2 && null == d2.__s && (d2.__s = d2.state), y2 && null != O2.getDerivedStateFromProps && (d2.__s == d2.state && (d2.__s = pS({}, d2.__s)), pS(d2.__s, O2.getDerivedStateFromProps(m2, d2.__s))), p2 = d2.props, h2 = d2.state, d2.__v = t2, f2)
          y2 && null == O2.getDerivedStateFromProps && null != d2.componentWillMount && d2.componentWillMount(), y2 && null != d2.componentDidMount && d2.__h.push(d2.componentDidMount);
        else {
          if (y2 && null == O2.getDerivedStateFromProps && m2 !== p2 && null != d2.componentWillReceiveProps && d2.componentWillReceiveProps(m2, E2), !d2.__e && null != d2.shouldComponentUpdate && false === d2.shouldComponentUpdate(m2, d2.__s, E2) || t2.__v == n2.__v) {
            for (t2.__v != n2.__v && (d2.props = m2, d2.state = d2.__s, d2.__d = false), t2.__e = n2.__e, t2.__k = n2.__k, t2.__k.some(function(e6) {
              e6 && (e6.__ = t2);
            }), C2 = 0; C2 < d2._sb.length; C2++)
              d2.__h.push(d2._sb[C2]);
        ...
        if (d2.context = E2, d2.props = m2, d2.__P = e5, d2.__e = false, D2 = Zw.__r, w2 = 0, y2) {
          for (d2.state = d2.__s, d2.__d = false, D2 && D2(t2), c2 = d2.render(d2.props, d2.state, d2.context), S2 = 0; S2 < d2._sb.length; S2++)
            d2.__h.push(d2._sb[S2]);
          d2._sb = [];
        } else
          do {
        ...
        if (t2.__v = null, u2 || null != i2)
          if (e6.then) {
            for (t2.__u |= u2 ? 160 : 128; s2 && 8 == s2.nodeType && s2.nextSibling; )
              s2 = s2.nextSibling;
          ...
          t2.__e = n2.__e, t2.__k = n2.__k, e6.then || kS(t2);
        Zw.__e(e6, t2, n2);
      }
    else
      null == i2 && t2.__v == n2.__v ? (t2.__k = n2.__k, t2.__e = n2.__e) : s2 = t2.__e = PS(n2.__e, t2, n2, r2, o2, i2, a2, u2, l2);
...
function PS(e5, t2, n2, r2, o2, i2, a2, s2, u2) {
  ...
  if ("svg" == y2 ? o2 = "http://www.w3.org/2000/svg" : "math" == y2 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != i2) {
    for (l2 = 0; l2 < i2.length; l2++)
      if ((p2 = i2[l2]) && "setAttribute" in p2 == !!y2 && (y2 ? p2.localName == y2 : 3 == p2.nodeType)) {
        e5 = p2, i2[l2] = null;
        break;
      }
  }
  ...
  if (null == y2)
    v2 === m2 || s2 && e5.data == m2 || (e5.data = m2);
  else {
    if (i2 = i2 && Xw.call(e5.childNodes), v2 = n2.props || lS, !s2 && null != i2)
      for (v2 = {}, l2 = 0; l2 < e5.attributes.length; l2++)
        v2[(p2 = e5.attributes[l2]).name] = p2.value;
    for (l2 in v2)
      if (p2 = v2[l2], "children" == l2)
        ;
      else if ("dangerouslySetInnerHTML" == l2)
        d2 = p2;
      else if (!(l2 in m2)) {
        if ("value" == l2 && "defaultValue" in m2 || "checked" == l2 && "defaultChecked" in m2)
          continue;
        NS(e5, l2, null, p2, o2);
      }
    for (l2 in m2)
      p2 = m2[l2], "children" == l2 ? f2 = p2 : "dangerouslySetInnerHTML" == l2 ? c2 = p2 : "value" == l2 ? h2 = p2 : "checked" == l2 ? g2 = p2 : s2 && "function" != typeof p2 || v2[l2] === p2 || NS(e5, l2, p2, v2[l2], o2);
    if (c2)
      s2 || d2 && (c2.__html == d2.__html || c2.__html == e5.innerHTML) || (e5.innerHTML = c2.__html), t2.__k = [];
    else if (d2 && (e5.innerHTML = ""), wS("template" == t2.type ? e5.content : e5, fS(f2) ? f2 : [f2], t2, n2, r2, "foreignObject" == y2 ? "http://www.w3.org/1999/xhtml" : o2, i2, a2, i2 ? i2[0] : n2.__k && bS(n2, 0), s2, u2), null != i2)
      for (l2 = i2.length; l2--; )
        hS(i2[l2]);
...
function RS(e5, t2, n2) {
  ...
  if (r2 = e5.__k)
    for (o2 = 0; o2 < r2.length; o2++)
      r2[o2] && RS(r2[o2], t2, n2 || "function" != typeof e5.type);
...
Xw = cS.slice, Zw = { __e: function(e5, t2, n2, r2) {
  for (var o2, i2, a2; t2 = t2.__; )
    if ((o2 = t2.__c) && !o2.__)
      try {
        if ((i2 = o2.constructor) && null != i2.getDerivedStateFromError && (o2.setState(i2.getDerivedStateFromError(e5)), a2 = o2.__d), null != o2.componentDidCatch && (o2.componentDidCatch(e5, r2 || {}), a2 = o2.__d), a2)
          return o2.__E = o2;
      } catch (t3) {
        e5 = t3;
      }
...
var KS;
var YS;
var XS = Object.freeze({ __proto__: null, Component: yS, Fragment: mS, cloneElement: function(e5, t2, n2) {
  var r2, o2, i2, a2, s2 = pS({}, e5.props);
  for (i2 in e5.type && e5.type.defaultProps && (a2 = e5.type.defaultProps), t2)
    "key" == i2 ? r2 = t2[i2] : "ref" == i2 ? o2 = t2[i2] : s2[i2] = void 0 === t2[i2] && null != a2 ? a2[i2] : t2[i2];
    ...
    mount(n3, r3) {
      ...
      if (l2) {
        ...
        return r4.classList.add("uppy-Root"), t2(this, s2)[s2] = /* @__PURE__ */ function(e6) {
          let t3 = null, n4 = null;
          return function() {
            for (var r5 = arguments.length, o3 = new Array(r5), i3 = 0; i3 < r5; i3++)
              o3[i3] = arguments[i3];
      ...
      let c2;
      if ("object" == typeof n3 && n3 instanceof u2)
        c2 = n3;
      ...
      if (c2)
        return this.uppy.log(`Installing ${a3} to ${c2.id}`), this.parent = c2, this.el = c2.addTarget(r3), this.onMount(), this.el;
  ...
  const t2 = function() {
    ...
    return mA = class extends t3 {
      ...
      static initPlugin(t4, n3, r3) {
        if (t4.type = "acquirer", t4.files = [], r3 && (t4.opts = { ...r3, ...n3 }), n3.serverUrl || n3.serverPattern)
          throw new Error("`serverUrl` and `serverPattern` have been renamed to `companionUrl` and `companionAllowedHosts` respectively in the 0.30.5 release. Please consult the docs (for example, https://uppy.io/docs/instagram/ for the Instagram plugin) and use the updated options.`");
        if (n3.companionAllowedHosts) {
          const e7 = n3.companionAllowedHosts;
          if (!("string" == typeof e7 || Array.isArray(e7) || e7 instanceof RegExp))
            throw new TypeError(`${t4.id}: the option "companionAllowedHosts" must be one of string, Array, RegExp`);
          t4.opts.companionAllowedHosts = e7;
        } else
          /^(?!https?:\/\/).*$/i.test(n3.companionUrl) ? t4.opts.companionAllowedHosts = `https://${n3.companionUrl.replace(/^\/\//, "")}` : t4.opts.companionAllowedHosts = new URL(n3.companionUrl).origin;
...
function WA() {
  ...
  function b2() {
    if (e5(this, i2)[i2] || e5(this, r2)[r2] >= this.limit)
      return;
    if (0 === e5(this, o2)[o2].length)
      return;
  ...
  VA.RateLimitedQueue = class {
    constructor(t3) {
      Object.defineProperty(this, h2, { value: C2 }), Object.defineProperty(this, p2, { value: E2 }), Object.defineProperty(this, f2, { value: b2 }), Object.defineProperty(this, d2, { value: y2 }), Object.defineProperty(this, c2, { value: m2 }), Object.defineProperty(this, r2, { writable: true, value: 0 }), Object.defineProperty(this, o2, { writable: true, value: [] }), Object.defineProperty(this, i2, { writable: true, value: false }), Object.defineProperty(this, a2, { writable: true, value: void 0 }), Object.defineProperty(this, s2, { writable: true, value: 1 }), Object.defineProperty(this, u2, { writable: true, value: void 0 }), Object.defineProperty(this, l2, { writable: true, value: void 0 }), Object.defineProperty(this, g2, { writable: true, value: () => this.resume() }), Object.defineProperty(this, v2, { writable: true, value: () => {
        if (e5(this, i2)[i2])
          e5(this, l2)[l2] = setTimeout(e5(this, v2)[v2], 0);
        else {
          e5(this, s2)[s2] = this.limit, this.limit = Math.ceil((e5(this, u2)[u2] + e5(this, s2)[s2]) / 2);
          for (let t4 = e5(this, s2)[s2]; t4 <= this.limit; t4++)
            e5(this, d2)[d2]();
    ...
    wrapPromiseFunction(e6, t3) {
      var n3 = this;
      return function() {
        for (var r3 = arguments.length, o3 = new Array(r3), i3 = 0; i3 < r3; i3++)
          o3[i3] = arguments[i3];
        let a3;
...
var qA = function() {
  ...
  const r2 = QS(), o2 = function() {
    ...
    return PA = class {
      ...
      remove() {
        for (const [t4, n4] of e6(this, o3)[o3].splice(0))
          e6(this, r3)[r3].off(t4, n4);
      }
    }, PA;
  }(), u2 = function() {
    if (LA)
  ...
  class h2 extends r2 {
    constructor(e6, t3) {
      ...
      if (this.opts = { ...r3, ...t3 }, this.i18nInit(), this.handleUpload = this.handleUpload.bind(this), n2.internalRateLimitedQueue in this.opts ? this.requests = this.opts[n2.internalRateLimitedQueue] : this.requests = new n2.RateLimitedQueue(this.opts.limit), this.opts.bundle && !this.opts.formData)
...
function mx() {
  ...
  var e5 = function() {
    ...
    var e6 = Go(), t3 = w(), n2 = A(), r2 = ce(), o2 = Jt(), i2 = gx(), a2 = t3([].push), s2 = function(t4) {
      ...
      return function(h2, g2, v2, m2) {
        for (var y2, b2, E2 = r2(h2), C2 = n2(E2), D2 = o2(C2), w2 = e6(g2, v2), S2 = 0, A2 = m2 || i2, x2 = s3 ? A2(h2, D2) : u2 || f2 ? A2(h2, 0) : void 0; D2 > S2; S2++)
          if ((p2 || S2 in C2) && (b2 = w2(y2 = C2[S2], S2, E2), t4))
            if (s3)
              x2[S2] = b2;
            else if (b2)
              switch (t4) {
...
!function() {
  ...
  for (var a2 in t2)
    t2[a2] && i2(e5[a2] && e5[a2].prototype);
  i2(n2);
}();
...
var bx = '<svg viewBox="0 0 1024 1024"><path d="M864 0a160 160 0 0 1 128 256l-64 64-224-224 64-64c26.752-20.096 59.968-32 96-32zM64 736l-64 288 288-64 592-592-224-224L64 736z m651.584-372.416l-448 448-55.168-55.168 448-448 55.168 55.168z"></path></svg>';
var Ex = '<svg viewBox="0 0 1024 1024"><path d="M924.402464 1023.068211H0.679665V99.345412h461.861399v98.909208H99.596867v725.896389h725.896389V561.206811h98.909208z" p-id="10909"></path><path d="M930.805104 22.977336l69.965436 69.965436-453.492405 453.492404-69.965435-69.901489z" p-id="10910"></path><path d="M1022.464381 304.030081h-98.917201V99.345412H709.230573V0.428211h313.233808z"></path></svg>';
var Cx = '<svg viewBox="0 0 1024 1024"><path d="M133.705143 335.433143V133.851429h201.581714a29.622857 29.622857 0 0 0 29.622857-29.549715V68.754286a29.622857 29.622857 0 0 0-29.622857-29.622857H61.732571A22.893714 22.893714 0 0 0 38.765714 62.025143V335.725714c0 16.310857 13.238857 29.622857 29.622857 29.622857h35.547429a29.842286 29.842286 0 0 0 29.696-29.842285zM690.980571 133.851429h201.581715v201.654857c0 16.310857 13.238857 29.549714 29.622857 29.549714h35.547428a29.622857 29.622857 0 0 0 29.549715-29.549714V61.952a22.893714 22.893714 0 0 0-22.820572-22.893714h-273.554285a29.622857 29.622857 0 0 0-29.549715 29.622857v35.547428c0 16.310857 13.238857 29.696 29.622857 29.696zM335.286857 892.781714H133.705143V691.2a29.622857 29.622857 0 0 0-29.622857-29.622857H68.534857a29.622857 29.622857 0 0 0-29.549714 29.622857v273.554286c0 12.653714 10.24 22.893714 22.820571 22.893714h273.554286a29.622857 29.622857 0 0 0 29.696-29.622857v-35.547429a29.769143 29.769143 0 0 0-29.769143-29.696z m557.348572-201.581714v201.581714H690.907429a29.622857 29.622857 0 0 0-29.622858 29.622857v35.547429c0 16.310857 13.238857 29.622857 29.622858 29.622857h273.554285c12.580571 0 22.893714-10.313143 22.893715-22.893714V691.2a29.622857 29.622857 0 0 0-29.622858-29.622857h-35.547428a29.622857 29.622857 0 0 0-29.696 29.622857z"></path></svg>';
var Dx = function() {
  function e5() {
...
var wx = { key: "blockquote", factory: function() {
  return new Dx();
} };
function Sx(e5) {
...
var kx = { renderElems: [Tx], elemsToHtml: [yx], parseElemsHtml: [Nx], menus: [wx], editorPlugin: function(e5) {
...
var Mx = { menus: [{ key: "codeBlock", factory: function() {
  return new Px();
...
var qx = { menus: [{ key: "enter", factory: function() {
  return new Gx();
} }] };
...
var Jx = { menus: [{ key: "emotion", factory: function() {
  return new Zx();
...
var eO = function(e5) {
  ...
  return Kg(t2, e5), t2.prototype.getOptions = function(e6) {
    ...
    t3.push({ text: QE("fontFamily.default"), value: "" }), r2.forEach(function(e7) {
      if ("string" == typeof e7)
        t3.push({ text: e7, value: e7, styleForRenderMenuList: { "font-family": e7 } });
...
var sO = { menus: [{ key: "fullScreen", factory: function() {
  return new aO();
} }] };
function uO(e5) {
...
var lO = { type: "header1", elemToHtml: uO(1) };
var cO = { type: "header2", elemToHtml: uO(2) };
var dO = { type: "header3", elemToHtml: uO(3) };
var fO = { type: "header4", elemToHtml: uO(4) };
var pO = { type: "header5", elemToHtml: uO(5) };
var hO = { type: "header6", elemToHtml: uO(6) };
function gO(e5) {
  var t2 = Qg(Kh.nodes(e5, { match: function(e6) {
...
var xO = { key: "headerSelect", factory: function() {
  return new AO();
} };
var OO = { key: "header1", factory: function() {
  return new bO();
} };
var NO = { key: "header2", factory: function() {
  return new EO();
} };
var BO = { key: "header3", factory: function() {
  return new CO();
} };
var TO = { key: "header4", factory: function() {
  return new DO();
} };
var kO = { key: "header5", factory: function() {
  return new wO();
} };
var FO = { key: "header6", factory: function() {
  return new SO();
} };
function IO(e5) {
...
var PO = { selector: "h1:not([data-w-e-type])", parseElemHtml: IO(1) };
var _O = { selector: "h2:not([data-w-e-type])", parseElemHtml: IO(2) };
var RO = { selector: "h3:not([data-w-e-type])", parseElemHtml: IO(3) };
var LO = { selector: "h4:not([data-w-e-type])", parseElemHtml: IO(4) };
var MO = { selector: "h5:not([data-w-e-type])", parseElemHtml: IO(5) };
var jO = { selector: "h6:not([data-w-e-type])", parseElemHtml: IO(6) };
function HO(e5) {
  return function(t2, n2, r2) {
...
var zO = { renderElems: [{ type: "header1", renderElem: HO(1) }, { type: "header2", renderElem: HO(2) }, { type: "header3", renderElem: HO(3) }, { type: "header4", renderElem: HO(4) }, { type: "header5", renderElem: HO(5) }, { type: "header6", renderElem: HO(6) }], elemsToHtml: [lO, cO, dO, fO, pO, hO], parseElemsHtml: [PO, _O, RO, LO, MO, jO], menus: [xO, OO, NO, BO, TO, kO, FO], editorPlugin: function(e5) {
  ...
  return n2.insertBreak = function() {
    ...
    if (o2)
      if (_y.isSelectionAtLineEnd(e5, o2[1])) {
  ...
  return Xg(this, arguments, void 0, function(e6, t3, n3, r2, o2) {
    ...
    return void 0 === r2 && (r2 = ""), void 0 === o2 && (o2 = ""), Zg(this, function(s2) {
      switch (s2.label) {
        ...
        case 1:
          if ("string" == typeof (a2 = s2.sent()))
            return t3.alert(a2, "error"), [2, false];
          if (null == a2)
            return [2, false];
          s2.label = 2;
        case 2:
...
var QO = function() {
  ...
  return e5.prototype.getSelectedImageNode = function(e6) {
    ...
    var h2 = this.$content;
    if (h2.empty(), h2.append(a2), h2.append(l2), h2.append(d2), null == f2)
      return h2[0];
  ...
  return e5.prototype.getValue = function(e6) {
    ...
    if (!this.isDisabled(e6)) {
      if (!t2 || "string" != typeof t2)
        throw new Error("View image link failed, image.href is '".concat(t2, "'"));
...
var sN = { onInsertedImage: function(e5) {
...
var dN = { renderElems: [cN], elemsToHtml: [$O], parseElemsHtml: [{ selector: "img:not([data-w-e-type])", parseElemHtml: function(e5, t2, n2) {
      ...
      switch (a2.label) {
        ...
        case 1:
          if ("string" == typeof (i2 = a2.sent()))
            return t2.alert(i2, "error"), [2, false];
          if (null == i2)
            return [2, false];
          a2.label = 2;
        case 2:
  ...
  return Xg(this, void 0, void 0, function() {
    ...
    return Zg(this, function(u2) {
      switch (u2.label) {
        ...
        case 2:
          if (r2 = u2.sent(), null == (o2 = e5.selection))
            return [2];
          if (fg.isCollapsed(o2)) {
            if ((a2 = _y.getLeftLengthOfMaxLength(e5)) <= 0)
              return [2];
            ...
            s2 = NN(r2), jg.wrapNodes(e5, s2, { split: true }), jg.collapse(e5, { edge: "end" });
          return [2];
      }
    });
  });
...
var IN = function() {
  ...
  return e5.prototype.getValue = function(e6) {
    ...
    var h2 = this.$content;
    if (h2.empty(), h2.append(s2), h2.append(c2), h2.append(f2), null == t2 || fg.isCollapsed(t2))
      u2.val("");
    else {
...
var _N = function() {
  ...
  return e5.prototype.getSelectedLinkElem = function(e6) {
    ...
    if (!this.isDisabled(e6)) {
      if (!t2 || "string" != typeof t2)
        throw new Error("View link failed, link url is '".concat(t2, "'"));
      window.open(t2, "_blank");
    }
  }, e5;
}();
var RN = { checkLink: function(e5, t2) {
  return true;
...
var MN = { key: "editLink", factory: function() {
  return new kN();
}, config: RN };
var jN = { key: "unLink", factory: function() {
  return new PN();
} };
var HN = { key: "viewLink", factory: function() {
  return new _N();
} };
var zN;
var $N;
var UN = { selector: "a:not([data-w-e-type])", parseElemHtml: function(e5, t2, n2) {
  var r2 = am(e5);
  return 0 === (t2 = t2.filter(function(e6) {
    return !!Cg.isText(e6) || !!n2.isInline(e6);
...
var GN = { renderElems: [WN], elemsToHtml: [SN], parseElemsHtml: [UN], menus: [LN, MN, jN, HN], editorPlugin: function(e5) {
  ...
  return o2.isInline = function(e6) {
    ...
    var t3 = e6.getData("text/plain");
    if (VN(t3)) {
      if (/<img[^>]+>/.test(e6.getData("text/html")))
        n2(e6);
      else if (!ON(o2)) {
        var r3 = o2.selection;
        if (null != r3) {
...
var fB = function() {
  ...
  return e5.prototype.getValue = function(e6) {
    ...
    return null == e6.selection || !!_y.getSelectedElems(e6).some(function(t2) {
      if (Kh.isVoid(e6, t2) && Kh.isBlock(e6, t2))
        return true;
      var n2 = t2.type;
...
var gB = { renderElems: [hB], elemsToHtml: [dB], preParseHtml: [{ selector: "ul.w-e-todo", preParseHtml: function(e5) {
  ...
  return n2.deleteBackward = function(n3) {
    ...
    if (r2 && fg.isCollapsed(r2)) {
      ...
      if (o2 && 0 === eg.string(o2).length)
        return void jg.setNodes(e5, { type: "paragraph" }, { mode: "highest" });
    }
    t2(n3);
  }, n2;
} };
...
var yB = [cB, Wx, rO, gN, CN, wN, dN, Xx, Jx, GN, Mx, kx, zO, XN, gB, iO, { menus: [{ key: "redo", factory: function() {
  return new vB();
...
function CB(e5, t2, n2) {
  for (var r2 = t2.type, o2 = function(e6, t3) {
    var n3 = {};
    for (var r3 in e6)
      Object.prototype.hasOwnProperty.call(e6, r3) && t3.indexOf(r3) < 0 && (n3[r3] = e6[r3]);
    if (null != e6 && "function" == typeof Object.getOwnPropertySymbols) {
      var o3 = 0;
      for (r3 = Object.getOwnPropertySymbols(e6); o3 < r3.length; o3++)
        t3.indexOf(r3[o3]) < 0 && Object.prototype.propertyIsEnumerable.call(e6, r3[o3]) && (n3[r3[o3]] = e6[r3[o3]]);
    }
    return n3;
  }(t2, ["type"]), i2 = void 0 !== n2 ? n2 : o2.level || 0, a2 = _y.findPath(e5, t2), s2 = a2; ; ) {
    if (0 === s2.length || 0 === a2[a2.length - 1])
      return null;
    s2 = og.previous(s2);
...
var SB = { type: "list-item", elemToHtml: function(e5, t2) {
  ...
  if (a2 > 0)
    for (var s2 = 0; s2 < a2; s2 += 1)
      n2 += "<".concat(i2, ">"), wB.push(i2);
  var u2 = function(e6) {
    var t3 = bB.get(e6);
    if (null == t3)
      return 0;
    var n3 = e6, r3 = n3.type, o3 = n3.ordered, i3 = void 0 !== o3 && o3, a3 = n3.level, s3 = void 0 === a3 ? 0 : a3, u3 = _y.findPath(t3, e6);
    if (u3[0] === t3.children.length - 1)
      return s3 + 1;
...
var kB = { selector: "li:not([data-w-e-type])", parseElemHtml: function(e5, t2, n2) {
  ...
  var o2 = function(e6) {
    ...
    for (var t3 = 0, n3 = e6.parent(), r3 = TB(n3); "ul" === r3 || "ol" === r3; )
      r3 = TB(n3 = n3.parent()), t3 += 1;
    return t3 - 1;
  }(r2);
        ...
        if (null != o3)
          if (0 !== r3.focus.offset)
            ...
            if (u2 > 0) {
              ...
              jg.setNodes(i2, { type: "paragraph", ordered: void 0, level: void 0 });
          }
        else
          t2(n3);
      }
...
var LB = { type: "table-row", elemToHtml: function(e5, t2) {
...
function $B(e5, t2) {
  for (var n2 = Qg(t2, 2), r2 = n2[0], o2 = n2[1], i2 = [], a2 = 2; a2 < arguments.length; a2++)
  ...
  try {
    for (var i2 = Jg(function(e6, t3) {
      ...
      return void 0 === t3 && (t3 = {}), Zg(this, function(E3) {
        switch (E3.label) {
          case 0:
            if (n3 = Qg(Kh.nodes(e6, { match: zB(e6, "table"), at: t3.at }), 1), !(r3 = n3[0]))
              return [2, []];
          ...
          case 2:
            ...
            try {
              for (y3 = void 0, d3 = Jg(Kh.nodes(e6, { match: zB(e6, "tr"), at: l3 })), f3 = d3.next(); !f3.done; f3 = d3.next())
                p3 = Qg(f3.value, 2), h3 = p3[1], c3.push(ev([], Qg(Kh.nodes(e6, { match: zB(e6, "th", "td"), at: h3 })), false));
            } catch (e7) {
              y3 = { error: e7 };
            } finally {
              try {
      ...
      for (var s2 = a2.value, u2 = [], l2 = 0, c2 = 0; c2 < s2.length; c2 += 1)
        s2[c2] && (l2 = Math.max(l2, s2[c2].length));
      for (c2 = 0; c2 < s2.length; c2 += 1)
        if (u2[c2] || (u2[c2] = []), s2[c2]) {
          for (var d2 = 0; d2 < s2[c2].length; d2 += 1)
            if (s2[c2][d2] && s2[c2][d2][0]) {
              for (var f2 = Qg(s2[c2][d2], 1)[0], p2 = f2.rowSpan, h2 = void 0 === p2 ? 1 : p2, g2 = f2.colSpan, v2 = void 0 === g2 ? 1 : g2, m2 = d2; u2[c2] && u2[c2][m2]; )
                m2 += 1;
              for (var y2 = 0; y2 < v2; y2 += 1)
                for (var b2 = 0; b2 < h2; b2 += 1) {
  ...
  return e5.prototype.getValue = function(e6) {
    ...
    if (!this.isDisabled(e6)) {
      ...
      if (!a2 || s2 <= 1)
        ...
        var u2 = UB(e6), l2 = 0;
        e:
          for (var c2 = 0; c2 < u2.length; c2 += 1)
            for (var d2 = 0; d2 < u2[c2].length; d2 += 1) {
        ...
        Kh.withoutNormalizing(e6, function() {
          for (var t3, n3, r3 = /* @__PURE__ */ new Set(), o3 = /* @__PURE__ */ new Set(), i3 = 0; i3 < u2.length; i3 += 1)
            if (u2[i3] && u2[i3][l2]) {
              ...
              if (d3 > 1 || f3 > 1 || p3 > 1 || h2 > 1) {
                ...
                if (v2 < 0 || v2 >= u2.length || !u2[v2] || !u2[v2][m2])
                  continue;
...
var JB = function() {
  ...
  return e5.prototype.getValue = function(e6) {
    ...
    if (!this.isDisabled(e6)) {
      ...
      if (((null == a2 ? void 0 : a2.children.length) || 0) <= 1)
        jg.removeNodes(e6, { mode: "highest" });
      else {
        ...
        e:
          for (var d2 = 0; d2 < l2.length; d2 += 1)
            for (var f2 = 0; f2 < l2[d2].length; f2 += 1) {
  ...
  return e5.prototype.getValue = function(e6) {
    ...
    if (!this.isDisabled(e6)) {
      ...
      if (null != a2) {
        ...
        if (null != s2) {
          for (var u2 = UB(e6), l2 = 0, c2 = 0; c2 < u2.length; c2 += 1)
            for (var d2 = 0; d2 < u2[c2].length; d2 += 1) {
              var f2 = Qg(u2[c2][d2], 1), p2 = Qg(f2[0], 2)[1];
              if (og.equals(i2, p2)) {
                l2 = d2;
          ...
          Kh.withoutNormalizing(e6, function() {
            for (var t3 = /* @__PURE__ */ new Set(), n3 = /* @__PURE__ */ new Set(), r3 = 0; r3 < u2.length; r3 += 1)
              if (u2[r3] && u2[r3][l2]) {
                ...
                if (a3 > 1 || c3 > 1 || d3 > 1 || f3 > 1) {
                  ...
                  if (p3 < 0 || p3 >= u2.length || !u2[p3] || !u2[p3][h2])
                    continue;
                  ...
                  if (t3.has(b2))
                    ...
                    for (var S2 = 0; S2 < C2; S2 += 1)
                      n3.add(p3 + S2);
                  }
                }
              }
            for (r3 = 0; r3 < u2.length; r3 += 1)
              if (!n3.has(r3) && u2[r3] && u2[r3][l2]) {
    ...
    if (!this.isDisabled(e6)) {
      ...
      e:
        for (var s2 = 0; s2 < i2.length; s2 += 1)
          for (var u2 = 0; u2 < i2[s2].length; u2 += 1) {
      ...
      0 !== d2 && Kh.withoutNormalizing(e6, function() {
        for (var t3 = a2 + 1, n3 = t3 >= 0 && t3 < i2.length, r3 = [], s3 = 0; n3 && s3 < i2[a2].length; s3 += 1) {
          ...
          if (l3 > 1 || c3 > 1) {
            var f2 = a2 - (l3 - 1);
            if (f2 < 0 || f2 >= i2.length || !i2[f2] || !i2[f2][s3])
              continue;
            var p2 = Qg(i2[f2][s3], 1), h2 = Qg(p2[0], 2), g2 = h2[0], v2 = h2[1], m2 = g2.rowSpan || 1;
            r3.push(s3), g2.hidden || jg.setNodes(e6, { rowSpan: m2 + 1 }, { at: v2 });
          }
        }
        for (var y2 = (e6.getMenuConfig("insertTable") || {}).minRowHeight, b2 = { type: "table-row", children: [], height: parseInt((void 0 === y2 ? 30 : y2).toString(), 10) || 30 }, E2 = 0; E2 < d2; E2 += 1)
          if (!r3.includes(E2)) {
  ...
  return Zg(this, function(l2) {
    switch (l2.label) {
      ...
      case 1:
        if (!(t2 && n2 < t2.length))
          return [3, 4];
        for (r2 = [], o2 = 0; o2 < t2[n2].length; o2 += 1)
          i2 = Qg(t2[n2][o2], 2), a2 = i2[0], s2 = i2[1], u2 = s2.ltr, 1 === s2.ttb && r2.push(a2), o2 += u2 - 1;
        return [4, r2];
      case 2:
        l2.sent(), l2.label = 3;
      case 3:
  ...
  return e5.prototype.getValue = function(e6) {
    ...
    if (this.canMerge(e6)) {
      ...
      if (t2 && t2.length) {
        ...
        Kh.withoutNormalizing(e6, function() {
          for (var n3, o3, a2, s2, u2, l2, c2 = /* @__PURE__ */ new Map(), d2 = [], f2 = 1 / 0, p2 = -1 / 0, h2 = 1 / 0, g2 = -1 / 0, v2 = 0; v2 < t2.length; v2 += 1)
            for (var m2 = 0; m2 < t2[v2].length; m2 += 1) {
          ...
          d2.sort(function(e7, t3) {
            for (var n4 = 0; n4 < Math.min(e7.length, t3.length); n4 += 1)
              if (e7[n4] !== t3[n4])
                return t3[n4] - e7[n4];
...
var AT = { selector: "table:not([data-w-e-type])", parseElemHtml: function(e5, t2, n2) {
  ...
  if (l2 && l2.length === c2)
    s2.columnWidths = Array.from(l2).map(function(e6) {
...
function BT(e5, t2, n2) {
  ...
  if ("backward" === n2 && 0 === r2.anchor.offset && (a2 = Kh.before(e5, r2)), "forward" === n2 && Kh.isEnd(e5, r2.anchor, r2.anchor.path) && (a2 = Kh.after(e5, r2)), null == a2)
    return false;
  var s2 = Kh.above(e5, { at: a2, match: function(e6) {
    return _y.checkNodeType(e6, "table-cell");
  } });
  if (null == s2 || null == i2 || !og.equals(s2[1], i2[1]))
    return false;
  var u2 = Kh.node(e5, a2);
  if (!Cg.isText(u2[0]) || u2[0].text.length < 2)
    return false;
...
function kT(e5) {
  ...
  try {
    for (var r2 = Jg(["paragraph", "header1", "header2", "header3", "header4", "header5", "header6", "blockquote", "list-item", "todo", "divider"]), o2 = r2.next(); !o2.done; o2 = r2.next()) {
      var i2 = o2.value;
      if (_y.getSelectedNodeByType(e5, i2))
        return true;
    }
  } catch (e6) {
    t2 = { error: e6 };
...
HT.on("mousedown", function(e5) {
  var t2 = e5.target;
  if (t2.closest('[data-block-type="table-cell"]'))
    RT = true;
...
var zT = AC(function(e5) {
  if (LT && null !== jT) {
    ...
    if (d2)
      t2 = function(e6, t3, n3, r3, o3) {
        var i3 = ev([], Qg(e6), false);
        if (t3 < 0 || t3 >= e6.length)
          return i3;
...
var JT = { type: "table", renderElem: function(e5, t2, n2) {
  var r2 = function(e6, t3) {
    ...
    if ("DIV" === t3.target.tagName && t3.preventDefault(), !n2.isDisabled()) {
      ...
      if (null != i3)
        i3.anchor.path[0] !== r3[0] && "DIV" === t3.target.tagName && n2.select(o3);
      else
        n2.select(o3);
    }
    ...
    !function(e6, t4, n3, r3) {
      if (!e6.isDisabled() && !RT && !LT) {
        ...
        if (Gm(f3) && d3 > (g3 = f3.getBoundingClientRect()).x + 5 && d3 < g3.x + g3.width - 5)
          return void (l3 && jg.setNodes(e6, { isHoverCellBorder: false, resizingIndex: -1 }, { mode: "highest" }));
        if (Gm(f3)) {
          var p3 = f3.closest(".table");
          if (p3) {
            for (var h3 = n3.clientX, g3 = p3.getBoundingClientRect(), v3 = "100%" === a3 ? PT(u3).map(function(e7) {
              return e7 * r3;
            }) : u3, m3 = IT(v3), y3 = 0; y3 < m3.length; y3 += 1)
              if (h3 - g3.x >= m3[y3] - 5 && h3 - g3.x < m3[y3] + 5) {
                if (c3 === y3)
                  return;
        ...
        if (Gm(s3)) {
          ...
          if (u3) {
            for (var l3 = n3.clientY, c3 = u3.getBoundingClientRect(), d3 = VT(o3.map(function(e7) {
              return e7.height || 30;
            })), f3 = 0; f3 < d3.length; f3 += 1)
              if (l3 - c3.y >= d3[f3] - 5 && l3 - c3.y < d3[f3] + 5) {
                if (a3 === f3)
                  return;
...
var ek = { type: "table-cell", renderElem: function(e5, t2, n2) {
  var r2 = function(e6, t3) {
...
var nk = { renderStyle: function(e5, t2) {
  ...
  if ("table" !== e5.type && "table-cell" !== e5.type)
    return t2;
  ...
  if (!["TABLE", "TD", "TH"].includes(e5.tagName))
    return t2;
  ...
  l2.insertBreak = function() {
    ...
    if (_y.getSelectedNodeByType(l2, "table")) {
      ...
      var r3 = Kh.next(e5);
      if (r3)
        r3[0] && r3[0].text && (r3 = null !== (t3 = Kh.above(e5, { at: r3[1] })) && void 0 !== t3 ? t3 : r3), jg.select(e5, r3[1]);
      else {
    ...
    if (t3) {
      ...
      if (NT(l2, t3.anchor))
        (n3 = Kh[a3 ? "before" : "after"](l2, t3.anchor)) && (i3.anchor = n3), r3 = true;
      if (NT(l2, t3.focus))
        (n3 = Kh[a3 ? "after" : "before"](l2, t3.focus)) && (i3.focus = n3), r3 = true;
      r3 && jg.setSelection(l2, i3), o2(e6);
    }
  }, l2.normalizeNode = function(e6) {
    var t3 = Qg(e6, 2), n3 = t3[0], r3 = t3[1];
    if ("table" !== _y.getNodeType(n3))
      return i2([n3, r3]);
    ...
    if (null != e6) {
      ...
      if (null != t3) {
        ...
        if (og.equals(n3.path.slice(0, 3), r3.path.slice(0, 3)))
          if (0 !== eg.string(t3).length) {
    ...
    e6.apply = function(n3) {
      if (!rg.isSelectionOperation(n3) || !n3.newProperties)
        return t3(n3);
      ...
      if (og.equals(s3, u3) || !$B(e6, [s3, u3], "table"))
        return aT.unselect(e6), t3(n3);
      try {
        var l3 = UB(e6, { at: s3 });
        if (!l3 || 0 === l3.length)
          return aT.unselect(e6), t3(n3);
        for (var c3 = VB.valueOf(0, 0), d3 = VB.valueOf(0, 0), f3 = false, p2 = false, h2 = 0; h2 < l3.length; h2 += 1)
          if (l3[h2]) {
            for (var g2 = 0; g2 < l3[h2].length; g2 += 1)
              if (l3[h2][g2]) {
        ...
        for (var y2 = VB.valueOf(Math.min(c3.x, d3.x), Math.min(c3.y, d3.y)), b2 = VB.valueOf(Math.max(c3.x, d3.x), Math.max(c3.y, d3.y)); ; ) {
          ...
          for (h2 = E2.x; h2 <= C2.x && h2 < l3.length; h2 += 1)
            if (l3[h2]) {
              for (g2 = E2.y; g2 <= C2.y && g2 < l3[h2].length; g2 += 1)
                if (l3[h2][g2]) {
          ...
          if (VB.equals(y2, E2) && VB.equals(b2, C2))
            break;
          y2 = E2, b2 = C2;
        }
        var O2 = [], N2 = /* @__PURE__ */ new WeakSet();
        for (h2 = y2.x; h2 <= b2.x && h2 < l3.length; h2 += 1)
          if (l3[h2]) {
            var B2 = [];
            for (g2 = y2.y; g2 <= b2.y && g2 < l3[h2].length; g2 += 1)
              if (l3[h2][g2]) {
  ...
  return l2.addMark = function(e6, t3) {
    ...
    if (void 0 === n3 && (n3 = {}), e6 === l2) {
      var r3 = qB.get(l2);
      if (r3 && r3.length > 0)
        return "hidden" in t3 || "rowSpan" in t3 || "colSpan" in t3 ? void f2.setNodes(e6, t3, n3) : void r3.forEach(function(r4) {
...
var Ek = { selector: 'div[data-w-e-type="video"]', parseElemHtml: function(e5, t2, n2) {
  ...
  if (l2.length > 0)
    return a2 = l2.attr("width") || "auto", s2 = l2.attr("height") || "auto", u2 = sk(u2 = l2.attr("style") || ""), bk(o2 = l2[0].outerHTML, i2, a2, s2, u2, sk(r2.attr("style") || "")["text-align"] || "center");
...
var wk = { renderElems: [Dk], elemsToHtml: [ik], preParseHtml: [Ck], parseElemsHtml: [Ek], menus: [{ key: "insertVideo", factory: function() {
  return new hk();
        ...
        case 0:
          return n2 = function(e6) {
            ...
            return t3 = YA(Yg(Yg({}, n3), { onProgress: function(t4) {
              ...
              if (a2)
                return a2(n4, function(t5, n5, r4) {
  ...
  return n2.insertData = function(r2) {
    if (GO(n2))
      ...
      if (o2.length <= 0)
        ...
        Array.prototype.slice.call(o2).some(function(e6) {
  ...
  var t2 = function(e6) {
    var t3 = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, n2 = 0, r2 = {}, o2 = { manual: e6.Prism && e6.Prism.manual, disableWorkerMessageHandler: e6.Prism && e6.Prism.disableWorkerMessageHandler, util: { encode: function e7(t4) {
      ...
      switch (n3 = n3 || {}, o2.util.type(t4)) {
        case "Object":
          if (i3 = o2.util.objId(t4), n3[i3])
            return n3[i3];
          for (var a3 in r3 = {}, n3[i3] = r3, t4)
            t4.hasOwnProperty(a3) && (r3[a3] = e7(t4[a3], n3));
          return r3;
        case "Array":
      ...
      for (var s3 in i3)
        if (i3.hasOwnProperty(s3)) {
          if (s3 == t4)
            for (var u3 in n3)
              n3.hasOwnProperty(u3) && (a3[u3] = n3[u3]);
      ...
      for (var i3, a3 = 0; i3 = r3.elements[a3++]; )
        o2.highlightElement(i3, true === t4, r3.callback);
      ...
      if (o2.hooks.run("before-sanity-check", u3), (s3 = u3.element.parentElement) && "pre" === s3.nodeName.toLowerCase() && !s3.hasAttribute("tabindex") && s3.setAttribute("tabindex", "0"), !u3.code)
        return o2.hooks.run("complete", u3), void (r3 && r3.call(u3.element));
      if (o2.hooks.run("before-highlight", u3), u3.grammar)
        if (n3 && e6.Worker) {
          ...
          l3(o2.highlight(u3.code, u3.grammar, u3.language));
      else
        l3(o2.util.encode(u3.code));
    }, highlight: function(e7, t4, n3) {
      var r3 = { code: e7, grammar: t4, language: n3 };
      if (o2.hooks.run("before-tokenize", r3), !r3.grammar)
      ...
      return l2(o3, o3.head, e7), s2(e7, o3, t4, o3.head, 0), function(e8) {
        for (var t5 = [], n4 = e8.head.next; n4 !== e8.tail; )
        ...
        if (n3.hasOwnProperty(f3) && n3[f3]) {
          ...
          for (var h2 = 0; h2 < p3.length; ++h2) {
            ...
            for (var C2 = g2.pattern || g2, D2 = r3.next, w2 = u3; D2 !== t4.tail && !(d3 && w2 >= d3.reach); w2 += D2.value.length, D2 = D2.next) {
              var S2 = D2.value;
              if (t4.length > e7.length)
                return;
              if (!(S2 instanceof i2)) {
                var A2, x2 = 1;
                if (y2) {
                  if (!(A2 = a2(C2, w2, e7, m2)) || A2.index >= e7.length)
                    break;
                  var O2 = A2.index, N2 = A2.index + A2[0].length, B2 = w2;
                  for (B2 += D2.value.length; O2 >= B2; )
                    B2 += (D2 = D2.next).value.length;
                  if (w2 = B2 -= D2.value.length, D2.value instanceof i2)
                    continue;
                  for (var T2 = D2; T2 !== t4.tail && (B2 < N2 || "string" == typeof T2.value); T2 = T2.next)
                    x2++, B2 += T2.value.length;
                  x2--, S2 = e7.slice(w2, B2), A2.index -= w2;
                } else if (!(A2 = a2(C2, 0, S2, m2)))
                  continue;
                O2 = A2.index;
    ...
    function c2(e7, t4, n3) {
      for (var r3 = t4.next, o3 = 0; o3 < n3 && r3 !== e7.tail; o3++)
        r3 = r3.next;
    ...
    if (e6.Prism = o2, i2.stringify = function e7(t4, n3) {
      ...
      var s3 = "";
      for (var u3 in i3.attributes)
        s3 += " " + u3 + '="' + (i3.attributes[u3] || "").replace(/"/g, "&quot;") + '"';
      return "<" + i3.tag + ' class="' + i3.classes.join(" ") + '"' + s3 + ">" + i3.content + "</" + i3.tag + ">";
    }, !e6.document)
      return e6.addEventListener ? (o2.disableWorkerMessageHandler || e6.addEventListener("message", function(t4) {
  ...
  e5.exports && (e5.exports = t2), void 0 !== y && (y.Prism = t2), t2.languages.markup = { comment: { pattern: /<!--(?:(?!<!--)[\s\S])*?-->/, greedy: true }, prolog: { pattern: /<\?[\s\S]+?\?>/, greedy: true }, doctype: { pattern: /<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i, greedy: true, inside: { "internal-subset": { pattern: /(^[^\[]*\[)[\s\S]+(?=\]>$)/, lookbehind: true, greedy: true, inside: null }, string: { pattern: /"[^"]*"|'[^']*'/, greedy: true }, punctuation: /^<!|>$|[[\]]/, "doctype-tag": /^DOCTYPE/i, name: /[^\s<>'"]+/ } }, cdata: { pattern: /<!\[CDATA\[[\s\S]*?\]\]>/i, greedy: true }, tag: { pattern: /<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/, greedy: true, inside: { tag: { pattern: /^<\/?[^\s>\/]+/, inside: { punctuation: /^<\/?/, namespace: /^[^\s>\/:]+:/ } }, "special-attr": [], "attr-value": { pattern: /=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/, inside: { punctuation: [{ pattern: /^=/, alias: "attr-equals" }, { pattern: /^(\s*)["']|["']$/, lookbehind: true }] } }, punctuation: /\/?>/, "attr-name": { pattern: /[^\s>\/]+/, inside: { namespace: /^[^\s>\/:]+:/ } } } }, entity: [{ pattern: /&[\da-z]{1,8};/i, alias: "named-entity" }, /&#x?[\da-f]{1,8};/i] }, t2.languages.markup.tag.inside["attr-value"].inside.entity = t2.languages.markup.entity, t2.languages.markup.doctype.inside["internal-subset"].inside = t2.languages.markup, t2.hooks.add("wrap", function(e6) {
    ...
    if (void 0 !== t2 && "undefined" != typeof document) {
      ...
      t2.hooks.add("before-highlightall", function(e7) {
        ...
        for (var n3, r3 = (e7 || document).querySelectorAll(i2), o3 = 0; n3 = r3[o3++]; )
...
zk || (zk = 1, function(e5) {
  ...
  for (var o2 = ["comment", "function-name", "for-or-select", "assign-left", "parameter", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"], i2 = r2.variable[1].inside, a2 = 0; a2 < o2.length; a2++)
    i2[o2[a2]] = e5.languages.bash[o2[a2]];
  ...
  e5.languages.markdown = e5.languages.extend("markup", {}), e5.languages.insertBefore("markdown", "prolog", { "front-matter-block": { pattern: /(^(?:\s*[\r\n])?)---(?!.)[\s\S]*?[\r\n]---(?!.)/, lookbehind: true, greedy: true, inside: { punctuation: /^---|---$/, "front-matter": { pattern: /\S+(?:\s+\S+)*/, alias: ["yaml", "language-yaml"], inside: e5.languages.yaml } } }, blockquote: { pattern: /^>(?:[\t ]*>)*/m, alias: "punctuation" }, table: { pattern: RegExp("^" + o2 + i2 + "(?:" + o2 + ")*", "m"), inside: { "table-data-rows": { pattern: RegExp("^(" + o2 + i2 + ")(?:" + o2 + ")*$"), lookbehind: true, inside: { "table-data": { pattern: RegExp(r2), inside: e5.languages.markdown }, punctuation: /\|/ } }, "table-line": { pattern: RegExp("^(" + o2 + ")" + i2 + "$"), lookbehind: true, inside: { punctuation: /\||:?-{3,}:?/ } }, "table-header-row": { pattern: RegExp("^" + o2 + "$"), inside: { "table-header": { pattern: RegExp(r2), alias: "important", inside: e5.languages.markdown }, punctuation: /\|/ } } } }, code: [{ pattern: /((?:^|\n)[ \t]*\n|(?:^|\r\n?)[ \t]*\r\n?)(?: {4}|\t).+(?:(?:\n|\r\n?)(?: {4}|\t).+)*/, lookbehind: true, alias: "keyword" }, { pattern: /^```[\s\S]*?^```$/m, greedy: true, inside: { "code-block": { pattern: /^(```.*(?:\n|\r\n?))[\s\S]+?(?=(?:\n|\r\n?)^```$)/m, lookbehind: true }, "code-language": { pattern: /^(```).+/, lookbehind: true }, punctuation: /```/ } }], title: [{ pattern: /\S.*(?:\n|\r\n?)(?:==+|--+)(?=[ \t]*$)/m, alias: "important", inside: { punctuation: /==+$|--+$/ } }, { pattern: /(^\s*)#.+/m, lookbehind: true, alias: "important", inside: { punctuation: /^#+|#+$/ } }], hr: { pattern: /(^\s*)([*-])(?:[\t ]*\2){2,}(?=\s*$)/m, lookbehind: true, alias: "punctuation" }, list: { pattern: /(^\s*)(?:[*+-]|\d+\.)(?=[\t ].)/m, lookbehind: true, alias: "punctuation" }, "url-reference": { pattern: /!?\[[^\]]+\]:[\t ]+(?:\S+|<(?:\\.|[^>\\])+>)(?:[\t ]+(?:"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|\((?:\\.|[^)\\])*\)))?/, inside: { variable: { pattern: /^(!?\[)[^\]]+/, lookbehind: true }, string: /(?:"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|\((?:\\.|[^)\\])*\))$/, punctuation: /^[\[\]!:]|[<>]/ }, alias: "url" }, bold: { pattern: n2(/\b__(?:(?!_)<inner>|_(?:(?!_)<inner>)+_)+__\b|\*\*(?:(?!\*)<inner>|\*(?:(?!\*)<inner>)+\*)+\*\*/.source), lookbehind: true, greedy: true, inside: { content: { pattern: /(^..)[\s\S]+(?=..$)/, lookbehind: true, inside: {} }, punctuation: /\*\*|__/ } }, italic: { pattern: n2(/\b_(?:(?!_)<inner>|__(?:(?!_)<inner>)+__)+_\b|\*(?:(?!\*)<inner>|\*\*(?:(?!\*)<inner>)+\*\*)+\*/.source), lookbehind: true, greedy: true, inside: { content: { pattern: /(^.)[\s\S]+(?=.$)/, lookbehind: true, inside: {} }, punctuation: /[*_]/ } }, strike: { pattern: n2(/(~~?)(?:(?!~)<inner>)+\2/.source), lookbehind: true, greedy: true, inside: { content: { pattern: /(^~~?)[\s\S]+(?=\1$)/, lookbehind: true, inside: {} }, punctuation: /~~?/ } }, "code-snippet": { pattern: /(^|[^\\`])(?:``[^`\r\n]+(?:`[^`\r\n]+)*``(?!`)|`[^`\r\n]+`(?!`))/, lookbehind: true, greedy: true, alias: ["code", "keyword"] }, url: { pattern: n2(/!?\[(?:(?!\])<inner>)+\](?:\([^\s)]+(?:[\t ]+"(?:\\.|[^"\\])*")?\)|[ \t]?\[(?:(?!\])<inner>)+\])/.source), lookbehind: true, greedy: true, inside: { operator: /^!/, content: { pattern: /(^\[)[^\]]+(?=\])/, lookbehind: true, inside: {} }, variable: { pattern: /(^\][ \t]?\[)[^\]]+(?=\]$)/, lookbehind: true }, url: { pattern: /(^\]\()[^\s)]+/, lookbehind: true }, string: { pattern: /(^[ \t]+)"(?:\\.|[^"\\])*"(?=\)$)/, lookbehind: true } } } }), ["url", "bold", "italic", "strike"].forEach(function(t3) {
    ...
    if ("code-block" === t3.type) {
      ...
      if (c2)
        t3.content = e5.highlight(function(e6) {
          var t4 = e6.replace(a2, "");
          return t4 = t4.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function(e7, t5) {
            var n4;
            if ("#" === (t5 = t5.toLowerCase())[0])
              return n4 = "x" === t5[1] ? parseInt(t5.slice(2), 16) : Number(t5.slice(1)), u2(n4);
            var r4 = s2[t5];
            return r4 || e7;
          }), t4;
        }(t3.content), c2, n3);
...
var qk = { key: "codeSelectLang", factory: function() {
  return new Gk();
...
@wangeditor-next/editor/dist/index.mjs:
  ...
  (**
  		 ...
  		 *)
*/
//# sourceMappingURL=chunk-UZUZA5A3.js.map
